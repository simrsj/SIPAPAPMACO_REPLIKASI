...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2022 at 10:00 AM
...
CREATE TABLE `tb_praktik` (
  ...
  `bayar_praktik` enum('T','Y') NOT NULL COMMENT 'Status Pembayaran Praktik'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tb_profesi_pdd` (`id_profesi_pdd`, `id_jurusan`, `nama_profesi_pdd`) VALUES
(0, 0, '-- Lainnya --'),
(1, 1, 'Program Pendidikan Dokter Spesialis (PPDS)'),
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', 1, '08123145645', NULL, '2022-11-01 5:41:04', '2021-03-29', '2022-02-22', 'Y'),
