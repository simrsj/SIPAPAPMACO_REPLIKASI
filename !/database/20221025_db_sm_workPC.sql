...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2022 at 11:36 AM
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', 1, '08123145645', NULL, '2022-10-25 4:07:44', '2021-03-29', '2022-02-22', 'Y'),
...
CREATE TABLE `tb_user_privileges` (
  `id_user` int(11) NOT NULL,
  `c_kuota` enum('N','Y') NOT NULL,
  `r_kuota` enum('N','Y') NOT NULL,
  `u_kuota` enum('N','Y') NOT NULL,
  `d_kuota` enum('N','Y') NOT NULL,
  `c_akun` enum('N','Y') NOT NULL,
  `r_akun` enum('N','Y') NOT NULL,
  `u_akun` enum('N','Y') NOT NULL,
  `d_akun` enum('N','Y') NOT NULL,
  `c_praktik` enum('N','Y') NOT NULL,
  `r_praktik` enum('N','Y') NOT NULL,
  `u_praktik` enum('N','Y') NOT NULL,
  `d_praktik` enum('N','Y') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tb_user_privileges` (`id_user`, `c_kuota`, `r_kuota`, `u_kuota`, `d_kuota`, `c_akun`, `r_akun`, `u_akun`, `d_akun`, `c_praktik`, `r_praktik`, `u_praktik`, `d_praktik`) VALUES
