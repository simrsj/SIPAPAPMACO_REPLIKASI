...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2022 at 09:45 AM
...
(14, '2022-11-27', NULL, '', 0, '', '', '', '', 0, 0, '', 4, 7, '', 'Y');
...
(5, 5, 1, 1, '2022-11-24', '2022-11-24', NULL, 6, 1440000);
...
(4, '1', 0, 11, 3, '5', '9', '3', 'Vel cupidatat id eos', '2022-11-14', NULL, '2022-11-14', '2022-12-14', 12, 'Quo commodo qui ut o', './_file/praktik/3d1c9046adf84f240c7ae28c389b36c1.pdf', NULL, 'Quasi rerum laborum', 'mufoqyxu@mailinator.com', '41', 'Y', '', 'T', 'T', 'T', 'T', NULL, NULL, NULL, NULL, NULL),
(5, '1', 0, 1, 1, '1', '9', '1', 'asd', '2022-11-15', NULL, '2022-11-15', '2022-11-20', 12, '123', './_file/praktik/724393b04a3b1f274128592e6143227f.pdf', NULL, 'ADMIN DIKLAT RS JIWA', 'admin@admin', '08123145645', 'Y', 'Y', 'T', 'T', 'T', 'T', NULL, NULL, NULL, NULL, NULL);
...
(1, 5, 0, '2022-11-27', NULL, 'Dolorem numquam culp', 'Maiores incidunt pr', '1998-02-16', '44', '87', 'tonymaqut@mailinator.com', 'Nemo laboris laborum', 'T'),
(2, 5, 0, '2022-11-27', NULL, 'Illum eos ad quis r', 'Eu et maiores ex ape', '2017-07-18', '10', '77', 'gulyc@mailinator.com', 'Consequat Quaerat e', 'T'),
(3, 5, 0, '2022-11-27', NULL, 'Enim soluta at ipsum', 'Quidem esse facilis', '1977-03-28', '21', '14', 'covef@mailinator.com', 'Lorem nesciunt quia', 'T'),
(4, 5, 0, '2022-11-27', NULL, 'asdiuasdiu', 'kasbdnkj', '2222-02-02', '321651651', '', '', 'asdasd', 'T'),
(5, 5, 0, '2022-11-27', NULL, 'Alias perferendis vi', 'Non lorem quisquam v', '2006-06-17', '40', '44', 'malekebux@mailinator.com', 'Hic deserunt elit a', 'T'),
(6, 5, 0, '2022-11-27', NULL, 'Qui in quia dolore a', 'In sed qui eaque hic', '1974-07-01', '99', '86', 'jibuwyvame@mailinator.com', 'Libero et aliquam et', 'T'),
(7, 5, 0, '2022-11-27', NULL, 'Voluptates excepturi', 'Rerum et dolores atq', '1980-08-22', '95', '60', 'watydebit@mailinator.com', 'Quisquam dolorem ver', 'T'),
(8, 5, 0, '2022-11-27', NULL, '123', 'fAJAR rACHMAT', '1998-09-18', '54', '70', 'suvukytu@mailinator.com', 'Dolore eaque labore ', 'T');
...
(1, 5, '2022-11-24', '2022-11-24', 'Pemakaian Kekayaan Daerah', 'Mess RSJ 1 Lama', 20000, 'per-siswa / hari', 6, 12, 1440000, NULL, NULL);
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', 1, '08123145645', NULL, '2022-11-27 6:20:37', '2021-03-29', '2022-02-22', NULL, 'Y'),
...
INSERT INTO `tb_user_privileges` (`id_user`, `c_kuota`, `r_kuota`, `u_kuota`, `d_kuota`, `c_akun`, `r_akun`, `u_akun`, `d_akun`, `c_praktik`, `r_praktik`, `u_praktik`, `d_praktik`, `c_praktikan`, `r_praktikan`, `u_praktikan`, `d_praktikan`, `c_praktik_mess`, `r_praktik_mess`, `u_praktik_mess`, `d_praktik_mess`, `c_praktik_pembimbing`, `r_praktik_pembimbing`, `u_praktik_pembimbing`, `d_praktik_pembimbing`, `c_narsum`, `r_narsum`, `u_narsum`, `d_narsum`) VALUES
(1, 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'T', 'T', 'T', 'T', 'Y', 'Y', 'Y', 'Y'),
(2, 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T');
...
--
ALTER TABLE `tb_praktikan`
  MODIFY `id_praktikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tb_praktik_tgl`
--
ALTER TABLE `tb_praktik_tgl`
  MODIFY `id_praktik_tgl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
...
--
ALTER TABLE `tb_tarif_pilih`
  MODIFY `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
