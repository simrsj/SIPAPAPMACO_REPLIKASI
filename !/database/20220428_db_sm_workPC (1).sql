...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2022 at 10:27 AM
...
CREATE TABLE `tb_institusi` (
  ...
  `tgl_input_institusi` date DEFAULT NULL,
...
INSERT INTO `tb_pembimbing` (`id_pembimbing`, `tgl_input_pembimbing`, `tgl_ubah_pembimbing`, `no_id_pembimbing`, `nama_pembimbing`, `id_pembimbing_jenis`, `id_jenjang_pdd`, `kali_pembimbing`, `status_pembimbing`) VALUES
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-04-28', '2021-03-29', '2022-02-22', 'Y'),
