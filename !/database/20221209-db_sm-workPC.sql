...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2022 at 11:41 AM
...
(47, 5, 0, '2022-12-07', NULL, 'Eiusmod et hic dolor', 'Consequuntur quia ve', '2006-02-24', '61', '97', 'zewe@mailinator.com', 'Suscipit dolorem qui', 'Y');
...
(3, 1, '2022-12-07', '2022-12-07', 'Administrasi', 'Suscipit officia inc', 37, 'per-hari', 98, 17, 61642, NULL, NULL, 'T'),
...
(11, 5, '2022-12-07', '2022-12-07', '-- Lainnya --', 'Incididunt voluptas ', 58, 'per-hari / orang', 13, 11, 8294, NULL, NULL, 'Y');
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', 1, '08123145645', NULL, '2022-12-09 02:07:26', '2021-03-29', '2022-02-22', NULL, 'Y'),
...
--
ALTER TABLE `tb_praktikan`
  MODIFY `id_praktikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
