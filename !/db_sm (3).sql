...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2022 at 10:48 AM
...
INSERT INTO `tb_user` (`id_user`, `id_mou`, `id_institusi`, `username_user`, `password_user`, `nama_user`, `email_user`, `level_user`, `no_telp_user`, `terakhir_login_user`, `tgl_buat_user`, `status_user`) VALUES
(1, 0, 0, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'ADMIN', '-', 1, '08123145645', '2021-12-31', '2021-03-29', 'Y'),
(15, 1, 87, 'asd@asd', '202cb962ac59075b964b07152d234b70', 'asd', 'asd@asd', 2, '091273', '2021-12-31', '2021-12-31', 'Y');
...
--
ALTER TABLE `tb_harga_pilih`
  MODIFY `id_harga_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
