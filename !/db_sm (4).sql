...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2022 at 01:42 AM
...
VALUES
  (
    ...
    'Bank BJB',
    '2022-01-01',
    './_file/bayar/bayar_0_3-2022-01-01.pdf'
  );
-- --------------------------------------------------------
  --
...
VALUES
  ...
  (
    26,
    'Materi (TAK, Komunikasi Terapeutik, Dokumentasi Keperawatanan) ',
    3,
    NULL,
    150000,
    '3',
...
--
  ...
  --
INSERT INTO
  `tb_harga_jenis` (`id_harga_jenis`, `nama_harga_jenis`)
VALUES
  (0, '-- Lainnya --'),
  (1, 'Administrasi'),
...
VALUES
  (
    1,
    'AKADEMI PEREKEM MEDIS DAN INFORMATIKA KESEHATAN (APIKES) BANDUNG',
    '',
    '',
    ''
  ),
  ...
  (
    22,
    'FAKULTAS KEDOKTERAN UNIVERSITAS JENDERAL AHMAD YANI CIMAHI',
    '',
    '',
    ''
  ),
  ...
  (
    26,
    'POLTEKKES KEMENKES BANDUNG KEPERAWATAN',
    '',
    '',
    ''
  ),
  ...
  (
    30,
    'PROGRAM PASCA SARJANA UNIVERSITAS ISLAM BANDUNG',
    '',
    '',
    ''
  ),
  ...
  (
    68,
    'UNIVERSITAS PENDIDIKAN INDONESIA KAMPUS SETIABUDI',
    '',
    '',
    ''
  ),
  ...
  (
    77,
    'POLTEKKES KEMENKES BANDUNG FARMASI',
    '',
    '',
    ''
  ),
  ...
  (
    79,
    'MAGISTER PSIKOLOGI PROFESI UNISBA',
    '',
    '',
    ''
  ),
  ...
  (
    85,
    'UNIVERSITAS KRISTEN SATYA WACANA SALATIGA (PSIKOLOGI)',
    '',
    '',
    ''
  ),
...
--
  ...
  --
INSERT INTO
  `tb_mentor_jenis` (`id_mentor_jenis`, `nama_mentor_jenis`)
VALUES
  (1, 'CI'),
  (2, 'CIL'),
  (3, 'PSPD'),
...
VALUES
  (
    ...
    0,
    0,
    'Autem fugiat qui sed',
    '2021-12-31',
    NULL,
    '2016-10-23',
    '1980-11-26',
    6,
    './_file/praktikan/surat_praktik_1_2021-12-31.pdf',
    './_file/praktikan/data_praktik_2_2021-12-30.xlsx',
    4,
    '7',
    '8',
    '0',
  ...
  (
    ...
    71,
    71,
    'Vitae nihil libero s',
    '2021-12-30',
    '2021-12-30',
    '1978-10-18',
    '1996-03-11',
    73,
    './_file/praktikan/surat_praktik_2_2021-12-30.pdf',
    './_file/praktikan/data_praktik_2_2021-12-30.xlsx',
    1,
    '1',
    '9',
    ...
    '2',
    '1',
    'Aut ut necessitatibu',
    'juduqeca@mailinator.com',
    '19',
    'DAFTAR',
    'T'
  ),
  (
    ...
    0,
    87,
    'Consequatur eos nihi',
    '2021-12-31',
    '2021-12-31',
    '2021-01-01',
    '2021-02-19',
    64,
    './_file/praktikan/surat_praktik_3_2021-12-31.pdf',
    './_file/praktikan/data_praktik_3_2021-12-31.xlsx',
    4,
    '7',
    '8',
    '0',
  ...
  (
    ...
    20,
    20,
    'Kelompok 2 Gelombang III',
    '2021-12-05',
    '2021-12-28',
    '2021-11-24',
    '2021-12-31',
    10,
    './_file/praktikan/surat_praktik_1_2021-11-23.pdf',
    './_file/praktikan/data_praktik_1_2021-11-23.xlsx',
    1,
    '1',
    '0',
    '1',
  ...
  (
    ...
    '2022-01-13',
    25,
    './_file/praktikan/surat_praktik_1_2021-12-03.pdf',
    './_file/praktikan/data_praktik_1_2021-12-03.xlsx',
    3,
    '4',
    '6',
    '0',
  ...
  (
    ...
    '2021-12-09',
    2,
    './_file/praktikan/surat_praktik_1_2021-12-06.pdf',
    './_file/praktikan/data_praktik_1_2021-12-06.xlsx',
    3,
    '3',
    '8',
    '0',
...
--
  ...
  --
INSERT INTO
  `tb_praktikan` (`id_praktikan`, `id_praktik`, `status_praktikan`)
VALUES
  (3, 3, 'INPUT PRAKTIKAN');
-- --------------------------------------------------------
  --
...
--
  ...
  --
INSERT INTO
  `tb_spesifikasi_pdd` (`id_spesifikasi_pdd`, `nama_spesifikasi_pdd`)
VALUES
  (0, '-- Lainnya --'),
...
ALTER TABLE
  `tb_praktikan_detail`
ADD
  PRIMARY KEY (`id_praktikan_detail`);
--
...
ALTER TABLE
  `tb_spesifikasi_pdd`
ADD
  PRIMARY KEY (`id_spesifikasi_pdd`);
--
...
ALTER TABLE
  `tb_harga_jenis`
MODIFY
  `id_harga_jenis` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 12;
--
...
ALTER TABLE
  `tb_harga_pilih`
MODIFY
  `id_harga_pilih` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 100;
--
...
ALTER TABLE
  `tb_harga_satuan`
MODIFY
  `id_harga_satuan` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 13;
--
...
ALTER TABLE
  `tb_praktikan_detail`
MODIFY
  `id_praktikan_detail` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 5;
--
...
ALTER TABLE
  `tb_spesifikasi_pdd`
MODIFY
  `id_spesifikasi_pdd` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 16;
--
