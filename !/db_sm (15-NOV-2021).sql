...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2021 at 09:20 AM
...
--
-- Table structure for table `tb_jenis_pmbb`
--

CREATE TABLE `tb_jenis_pmbb` (
  `id_jenis_pmbb` int(11) NOT NULL,
  `nama_jenis_pmbb` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tb_jenis_pmbb`
--

INSERT INTO `tb_jenis_pmbb` (`id_jenis_pmbb`, `nama_jenis_pmbb`) VALUES
(1, 'CI'),
(2, 'CIL'),
(3, 'PPDS'),
(4, 'PSPD');
...
CREATE TABLE `tb_jenjang_pdd` (
  ...
  `name_jenjang_pdd` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tb_jenjang_pdd` (`id_jenjang_pdd`, `name_jenjang_pdd`) VALUES
(1, 'SMA'),
(2, 'SMK'),
(3, 'D3'),
(4, 'D4'),
...
CREATE TABLE `tb_mou` (
  ...
  `spek_pdd_mou` text NOT NULL,
  `jenjang_pdd_mou` text NOT NULL,
...
INSERT INTO `tb_mou` (`id_mou`, `institusi_mou`, `tgl_mulai_mou`, `tgl_selesai_mou`, `no_rsj_mou`, `no_institusi_mou`, `jurusan_mou`, `spek_pdd_mou`, `jenjang_pdd_mou`, `akreditasi_mou`, `ket_mou`) VALUES
...
(6, 'AKPER DUSTIRA CIMAHI', '2018-07-06', '2021-07-05', '119/11581/RSJ', 'PKS/008/AKPER RSD/VII/2018', '', '', '', '', ''),
(7, 'AKPER PEMERINTAH KABUPATEN CIANJUR', '2018-11-12', '2021-11-11', '119/20549A/RSJ', '420/526/AKPER/2018', '', '', '', '', ''),
(8, 'AKPER KEBONJATI', '2015-01-02', '2018-01-01', '-', 'YK/AKTI/PKS/01/01/2015', '', '', '', '', ''),
(9, 'AKPER LUWUK', '2019-02-06', '2022-02-05', '119/2418/RSJ', '032/AL.A/SKS.01/II/2019', '', '', '', '', ''),
...
(14, 'AKPER SAIFUDDIN ZUHRI INDRAMAYU', '2018-09-12', '2021-09-11', '119/16344/RSJ', '007 KS/AKSARI/IX/2018', '', '', '', '', ''),
...
(26, 'POLTEKKES KEMENKES BANDUNG KEPERAWATAN', '2018-11-19', '2021-11-18', '119/209634/RSJ', 'HK.05.01/1.6/5004/2018', '', '', '', '', ''),
(27, 'POLTEKKES TNI AU CIUMBULEUIT BANDUNG', '2020-01-08', '2023-01-07', '075/0409/RSJ/I/2020', '016/POLTEKKES/I/2020', '', '', '', '', ''),
(28, 'POLTEKKES BANTEN', '2012-06-04', '2015-06-04', '-', '-', '', '', '', '', ''),
(29, 'POLTEKKES KEMENKES MAKASSAR', '2014-12-12', '2017-12-11', '-', '-', '', '', '', '', ''),
(30, 'PROGRAM PASCA SARJANA UNIVERSITAS ISLAM BANDUNG', '2014-09-26', '2017-09-25', '-', '-', '', '', '', '', ''),
(31, 'STIKES AISYIYAH BANDUNG', '2019-04-08', '2022-04-07', '073/6519/RSJ', '808/MOU.02/STIKES-AB/IV/2019', '', '', '', '', ''),
...
(36, 'STIKES BUDILUHUR CIMAHI', '2018-07-03', '2021-07-02', '073/11261/RSJ', '505/D/BAHUK-STIKES/VII/2018', '', '', '', '', ''),
(37, 'STIKES CIREBON', '2020-11-02', '2023-11-02', '073/0090/RSJ', '672/B/STIKESCRB/I/2018', '', '', '', '', ''),
...
(40, 'STIKES FALETEHAN', '2018-07-13', '2021-07-12', '073/12321/RSJ', '810/STIKES-FA/MOU/VII/2018', '', '', '', '', ''),
(68, 'UNIVERSITAS PENDIDIKAN INDONESIA KAMPUS SETIABUDI', '2019-01-21', '2022-01-20', '119/1332/RSJ', '0223/UN40.A6/DN/2019', '', '', '', '', ''),
(69, 'UNIVERSITAS RESPATI INDONESIA', '2014-09-04', '2017-09-03', '-', '-', '', '', '', '', ''),
(70, 'UNIVERSITAS SAMRATULANGI', '2014-01-01', '2016-12-31', '-', '-', '', '', '', '', ''),
(71, 'UNIVERSITAS SULTAN AGENG TIRTAYASA (UNTIRTA)', '2019-04-16', '2022-04-15', '119/6207/RSJ', 'T/5/UN43.2/HK.07.00/2019', '', '', '', '', ''),
(72, 'POLITEKNIK TEDC BANDUNG', '2019-02-01', '2022-01-31', '073/4052/RSJ', '003.01/TEDC/MOU-DIR/II/2019', '', '', '', '', ''),
(73, 'UNIVERSITAS PELITA HARAPAN', '2019-03-28', '2022-03-27', '073/5921/RSJ', '002/FOM-UPH/PKS/III/2019', '', '', '', '', ''),
(74, 'POLTEKKES YAPKESBI SUKABUMI', '2019-02-04', '2022-02-03', '119/2307/RSJ', '0098/Q/P.Y.SMI/II/2019', '', '', '', '', ''),
(75, 'AKPER YPIB MAJALENGKA', '2018-11-09', '2021-11-08', '119/20494/RSJ', '168/AKPER/B-MOU/IX/2018', '', '', '', '', ''),
...
(81, 'SEKOLAH TINGGI ILMU KESEHATAN INDONESIA MAJU', '2019-04-26', '2022-04-25', '070/7441/RSJ', '1932/MOU/K/Ka./STIKIM/VI/2019', '', '', '', '', ''),
(82, 'UNIVERSITAS BHAKTI KENCANA (UBK)', '2019-09-26', '2022-09-25', '073/16246/RSJ/IX/2019', '04/14/UBK/IX/2019', '', '', '', '', ''),
(83, 'POLTEKKES KEMENKES JAYAPURA', '2019-12-16', '2022-12-15', '073/21320/RSJ/XII/2019', 'HK.03.01/1.6/0012/2019', '', '', '', '', ''),
(84, 'POLITEKNIK NEGERI INDRAMAYU', '2020-07-30', '2023-07-30', '073/11662/RSJ', '888/PL42/KS/2020', '', '', '', '', ''),
(85, 'UNIVERSITAS KRISTEN SATYA WACANA SALATIGA (PSIKOLOGI)', '2020-11-18', '2023-11-18', '073/18973/RSJ', '247/PKS/UKSW/XI/2020', '', '', '', '', ''),
(86, 'FAKULTAS PSIKOLOGI MARANATHA', '2020-11-02', '2023-11-02', '073/16336/RSJ', '037/PKS/DN/FKUKMXI/2020', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `tb_pdd_pmbb`
--

CREATE TABLE `tb_pdd_pmbb` (
  `id_mentor_edu` int(11) NOT NULL,
  `name_mentor_edu` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tb_pdd_pmbb`
--

INSERT INTO `tb_pdd_pmbb` (`id_mentor_edu`, `name_mentor_edu`) VALUES
(1, 'D3'),
(2, 'S1'),
(3, 'S2'),
(4, 'S3');
...
INSERT INTO `tb_user` (`id_user`, `username_user`, `password_user`, `nama_user`, `email_user`, `level_user`, `terakhir_login_user`, `tgl_buat_user`, `status_user`) VALUES
(1, 'admin', 'admin', 'ADMIN', '-', 1, '0000-00-00', '2021-03-29', 'Y'),
...
--
-- Indexes for table `tb_jenis_pmbb`
--
ALTER TABLE `tb_jenis_pmbb`
  ADD PRIMARY KEY (`id_jenis_pmbb`);
...
--
-- Indexes for table `tb_pdd_pmbb`
--
ALTER TABLE `tb_pdd_pmbb`
...
--
ALTER TABLE `tb_mou`
  MODIFY `id_mou` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
