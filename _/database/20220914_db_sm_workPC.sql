...
(1, NULL, 1, 'B1220914', 'Ferlistian', '0255484985646', 'Bank XXX', '2022-09-14', '2022-09-14', './_file/bayar/bayar_1_1_2022-09-14.pdf');
...
(1, 1, 1, '2022-09-14', 'y', 22, 15400000);
...
(1, 24, 1, 1, 13, '100', '90', '90', '90', '90', '90', '90', '90', '90', '90', '-'),
(2, 24, 1, 2, 13, '90', '90', '90', '90', '90', '90', '90', '90', '90', '90', '-'),
(3, 24, 1, 3, 13, '90', '90', '90', '90', '90', '90', '90', '90', '90', '90', '-'),
(4, 24, 1, 4, 13, '90', '90', '90', '90', '90', '90', '90', '90', '90', '90', '-');
...
(1, 0, 87, 'Kelompok 1', '2022-09-14', NULL, '2022-10-07', '2022-10-28', 7, '02/SEP/2022', './_file/praktik/surat_1_2022-09-14.pdf', './_file/praktik/data_praktikan_1_2022-09-14.xlsx', 2, '2', '9', '5', '1', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '08123145645', 'SLS', 'A', '', '', '', 'y', 'y', 'y', './_file/inv/inv_1_2022-09-14.pdf', './_file/nilai/nilai_kep_1_2022-09-14.pdf');
...
(1, 1, '1010202201', 'ADE IHSAN MR.', '0000-00-00', '0811209312322', '0811209312322', 'adeamr@gmail.com', 'KOTA BANDUNG', '2022-09-14', NULL, 'y', 0),
(2, 1, '1010202202', 'ASEP SAEPUDIN', '0000-00-00', '0812312329822', '0812312329822', 'asep@gmail.com', 'KOTA BANDUNG', '2022-09-14', NULL, 'y', 0),
(3, 1, '1010202203', 'FAJAR RACHMAT HERMANSYAH', '0000-00-00', '0822237891722', '0822113232311', 'fajar@gmail.com', 'KAB. BANDUNG', '2022-09-14', NULL, 'y', 0),
(4, 1, '1010202204', 'FERLISTIAN RIZKI', '0000-00-00', '0822337031729', '0822337031729', 'ferlis@gmail.com', 'KAB. BANDUNG', '2022-09-14', NULL, 'y', 0),
(5, 1, '1010202205', 'LUKMAN SALEHUDIN', '0000-00-00', '0822113232311', '0898298332323', 'lukman@gmail.com', 'KAB. BANDUNG', '2022-09-14', NULL, 'y', 0),
(6, 1, '1010202206', 'RANI RIFFANI', '0000-00-00', '0822237001728', '0822237001728', 'raniriff@gmail.com', 'KAB. BANDUNG', '2022-09-14', NULL, 'y', 0),
(7, 1, '1010202207', 'RIZKI EGI ', '0000-00-00', '0891278318723', '0892831238723', 'egi.rizki@gmail.com', 'KOTA CIMAHI', '2022-09-14', NULL, 'y', 0);
...
(1, 1, '2022-09-14', NULL, 'Administrasi', 'Institusional Fee', 20000, 'per-siswa / periode', 1, 7, 140000, NULL, NULL),
(2, 1, '2022-09-14', NULL, 'Administrasi', 'Management Fee', 20000, 'per-siswa / periode', 1, 7, 140000, NULL, NULL),
(3, 1, '2022-09-14', NULL, 'Barang Habis Pakai', 'Untuk Keselamatan Kerja (Handrub, tisue, sabun)', 20000, 'per-siswa / periode', 1, 7, 140000, NULL, NULL),
(4, 1, '2022-09-14', NULL, 'Overhead Operational', 'Name Tag (dibayar 1 kali)', 10000, 'per-siswa / periode', 1, 7, 70000, NULL, NULL),
(5, 1, '2022-09-14', NULL, 'Overhead Operational', 'Orientasi ', 75000, 'per-periode / kali', 1, 1, 75000, NULL, NULL),
(6, 1, '2022-09-14', NULL, 'Pembelajaran', 'Materi (TAK, Komunikasi Terapeutik, Dokumentasi Keperawatanan, UPIP, NAPZA)', 150000, 'per-periode / kali', 5, 1, 750000, NULL, NULL),
(7, 1, '2022-09-14', NULL, 'Pembelajaran', 'Bed side teaching (BST) / Bimbingan', 75000, 'persiswa / minggu', 3, 7, 1575000, NULL, NULL),
(8, 1, '2022-09-14', NULL, 'Pemakaian Kekayaan Daerah', 'Aula Napza', 750000, 'per-hari / kegiatan', 1, 1, 750000, NULL, NULL),
(9, 1, '2022-09-14', NULL, 'Pemakaian Kekayaan Daerah', 'Mess RSJ 1 Lama (Dengan Makan 3x Sehari)', 100000, 'per-siswa / hari', 22, 7, 15400000, NULL, 'y');
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-09-14', '2021-03-29', '2022-02-22', 'Y'),
...
--
ALTER TABLE `tb_nilai_kep`
  MODIFY `id_nilai_kep` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_praktikan`
  MODIFY `id_praktikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tb_praktik_tgl`
--
ALTER TABLE `tb_praktik_tgl`
  MODIFY `id_praktik_tgl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `tb_tarif_pilih`
  MODIFY `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
