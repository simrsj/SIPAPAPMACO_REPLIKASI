...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2022 at 09:58 AM
...
CREATE TABLE `tb_praktik` (
  ...
  `status_mess_praktik` enum('T','Y') DEFAULT NULL COMMENT 'stasus pemilihan mess',
  `status_pembimbing_praktik` enum('T','Y') NOT NULL COMMENT 'status pembimbing praktikan',
  `status_tarif_praktik` int(11) NOT NULL COMMENT 'status tarif praktik',
...
(1, '1', 0, 11, 3, '5', '', '', '', '2022-11-14', NULL, '2022-11-14', '2022-12-14', 0, 'Iste dolorem volupta', './_file/praktik/surat_1_2022-11-14.pdf', '', '', '', '', 'Y', NULL, 'T', 0, 'T', NULL, NULL, NULL, NULL, NULL),
(2, '1', 0, 11, 3, '3', '9', '4', '', '2022-11-14', NULL, '2022-11-14', '2022-12-14', 0, 'Quo commodo qui ut o', './_file/praktik/3d1c9046adf84f240c7ae28c389b36c1.pdf', NULL, '', '', '', 'Y', NULL, 'T', 0, 'T', NULL, NULL, NULL, NULL, NULL),
(3, '1', 0, 11, 3, '3', '', '', 'Vel cupidatat id eos', '2022-11-14', NULL, '2022-11-14', '2022-12-14', 12, 'Quo commodo qui ut o', './_file/praktik/3d1c9046adf84f240c7ae28c389b36c1.pdf', NULL, 'Quasi rerum laborum', 'mufoqyxu@mailinator.com', '41', 'Y', NULL, 'T', 0, 'T', NULL, NULL, NULL, NULL, NULL),
(4, '1', 0, 11, 3, '5', '9', '3', 'Vel cupidatat id eos', '2022-11-14', NULL, '2022-11-14', '2022-12-14', 12, 'Quo commodo qui ut o', './_file/praktik/3d1c9046adf84f240c7ae28c389b36c1.pdf', NULL, 'Quasi rerum laborum', 'mufoqyxu@mailinator.com', '41', 'Y', NULL, 'T', 0, 'T', NULL, NULL, NULL, NULL, NULL),
(5, '1', 0, 1, 1, '1', '9', '1', 'asd', '2022-11-15', NULL, '2022-11-15', '2022-11-20', 12, '123', './_file/praktik/724393b04a3b1f274128592e6143227f.pdf', NULL, 'ADMIN DIKLAT RS JIWA', 'admin@admin', '08123145645', 'Y', 'Y', 'T', 0, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', 1, '08123145645', NULL, '2022-11-17 7:13:37', '2021-03-29', '2022-02-22', NULL, 'Y'),
