...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2022 at 05:01 AM
...
(24, NULL, '2022-11-28', '197301072005011007', 'Abdul Aziz, AMK', 4, 6, 0, 'Y'),
...
(4, '1', 0, 31, 2, '2', '8', '', 'Kelompok 2', '2022-11-29', NULL, '2023-01-01', '2023-01-02', 3, '1', NULL, NULL, 'ADMIN DIKLAT RS JIWA', 'admin@admin', '08123145645', 'Y', 'Y', 'T', 'T', 'T', 'T', NULL, NULL, NULL, NULL, NULL),
...
(1, 5, '2022-11-24', '2022-11-27', 'Pemakaian Kekayaan Daerah', 'Mess RSJ 1 Lama', 20000, 'per-siswa / hari', 6, 12, 1440000, NULL, NULL),
(2, 1, '2022-11-29', NULL, 'Pemakaian Kekayaan Daerah', 'Mess RSJ 1 Lama', 20000, 'per-siswa / hari', 31, 5, 3100000, NULL, NULL),
(3, 4, '2022-11-29', '2022-11-29', 'Pemakaian Kekayaan Daerah', 'Mess RSJ 2 Baru', 20000, 'per-siswa / hari', 2, 3, 120000, NULL, NULL),
(4, 2, '2022-11-29', NULL, 'Pemakaian Kekayaan Daerah', 'Mess RSJ 1 Lama', 20000, 'per-siswa / hari', 31, 2, 1240000, NULL, NULL);
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', 1, '08123145645', NULL, '2022-11-29 3:15:19', '2021-03-29', '2022-02-22', NULL, 'Y'),
...
INSERT INTO `tb_user_privileges` (`id_user`, `c_kuota`, `r_kuota`, `u_kuota`, `d_kuota`, `c_akun`, `r_akun`, `u_akun`, `d_akun`, `c_praktik`, `r_praktik`, `u_praktik`, `d_praktik`, `c_praktikan`, `r_praktikan`, `u_praktikan`, `d_praktikan`, `c_praktik_mess`, `r_praktik_mess`, `u_praktik_mess`, `d_praktik_mess`, `c_praktik_pembimbing`, `r_praktik_pembimbing`, `u_praktik_pembimbing`, `d_praktik_pembimbing`, `c_narsum`, `r_narsum`, `u_narsum`, `d_narsum`, `c_daftar_pembimbing`, `r_daftar_pembimbing`, `u_daftar_pembimbing`, `d_daftar_pembimbing`) VALUES
(1, 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'T', 'T', 'T', 'T'),
(2, 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T', 'T');
