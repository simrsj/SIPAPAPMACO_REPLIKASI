...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 08, 2023 at 09:53 AM
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', '', 'ADMIN DIKLAT RS JIWA', 'admin@admin', 1, '08123145645', NULL, '2023-02-08 01:46:35', '2021-03-29', '2022-02-22', '', 'Y', 'Y'),
...
--
ALTER TABLE `tb_praktikan`
  MODIFY `id_praktikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `tb_praktik_tgl`
--
ALTER TABLE `tb_praktik_tgl`
  MODIFY `id_praktik_tgl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `tb_tarif_pilih`
  MODIFY `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
