...
<body>
	...
	<center>
		...
		<table border="1" class='table table-striped table-hover'>
			...
			<tr>
				<td><?php echo $no++; ?></td>
				<td><?php echo $data['nama_mess']; ?></td>
                <td><?php echo $data['nama_pemilik_mess']; ?></td>
                <td><?php echo $data['no_pemilik_mess']; ?></td>
                <td><?php echo $data['alamat_mess']; ?></td>
                <td><?php echo $data['kapasitas_t_mess']; ?></td>
                <td><?php echo $data['kapasitas_terisi_mess']; ?></td>
                <td><?php echo "Rp " . number_format($data['harga_tanpa_makan_mess'], 0, ",", "."); ?></td>
                <td><?php echo "Rp " . number_format($data['harga_dengan_makan_mess'], 0, ",", "."); ?></td>
