...
if (isset($_POST['tambah_user'])) {
    ...
    //CARI USERNAME DAN EMAIL YANG SAMA
    $sql_cari = "SELECT * FROM tb_user";
    $q_cari = $conn->query($sql_cari);
    while ($d_cari = $q_cari->fetch(PDO::FETCH_ASSOC)) {
        if ($_POST['username_user'] == $d_cari['username_user']) {
            echo "
            <script>
        ...
        if ($_POST['email_user'] == $d_cari['email_user']) {
            echo "
            <script>
    ...
    if ($_POST['password_user'] != $_POST['ulangi_password_user']) {
        ...
        $sql_tambah_akun = " INSERT INTO tb_akun (
            username_user, 
            password_user,
            nama_user,
            email_user
        ...
        echo $sql_tambah_akun . "<br";
        // $conn->query($sql_tambah_akun);

        echo "
        <script>
            alert('DATA AKUN SUDAH DITAMBAH');
        </script>
        ";
    }
    echo "
