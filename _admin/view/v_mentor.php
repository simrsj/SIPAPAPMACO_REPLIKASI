                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    ?>
                                    <td>
                                        <a class='btn btn-secondary btn-sm' href='#' data-toggle='modal' data-target='<?php echo "#pmb_u_m" . $d_mentor_rsj[' id_mentor_rsj']; ?>'>
                                            Ubah
                                        </a>
                                        <a href='?pmb_d&id=<?php echo $d_mentor_rsj[' id_mentor_rsj']; ?>' class='btn btn-danger btn-sm'>
