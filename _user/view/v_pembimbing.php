                                ...
                                if($r_mentor_rsj>0){
                                    ...
                                    while ($d_mentor_rsj = $q_mentor_rsj_a->fetch(PDO::FETCH_ASSOC)){
                                        ...
                                        <div class="modal fade" 
                                            id="<?php echo "pmb_u_m".$d_mentor_rsj['id_mentor_rsj']; ?>">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <form method="post" action="?pmb&u">
                                                            ...
                                                            <p>NIP/NIPK : <br>
                                                            <input name="nip_nipk_mentor_rsj" value="<?php echo $d_mentor_rsj['nip_nipk_mentor_rsj']; ?>"><br></p>
                                                            <p>Nama Pembimbing : <br>
                                                            <input name="name_mentor_rsj" value="<?php echo $d_mentor_rsj['name_mentor_rsj']; ?>" size="35px"><br></p>
                                                            <p>Unit/Ruangan : <br>
                                                            ...
                                                            <?php
                                                            $sql_mentor_kind="SELECT * FROM tb_mentor_kind order by name_mentor_kind ASC";
                                
                                                            $q_mentor_kind=$conn->query($sql_mentor_kind);
                                                            $r_mentor_kind=$q_mentor_kind->rowCount();

                                                            if($r_mentor_kind>0)
                                                            {
                                                                echo "<select name='info_mentor_rsj'>";
                                                                while($d_mentor_kind=$q_mentor_kind->fetch(PDO::FETCH_ASSOC))
                                                                {
                                                                    if(strtolower($d_mentor_kind['name_mentor_kind'])==strtolower($d_mentor_rsj['info_mentor_rsj']))
                                                                    {
                                                                        echo"
                                                                            <option selected value='".$d_mentor_kind['name_mentor_kind']."'>".$d_mentor_kind['name_mentor_kind']."</option>
                                                                            ";  
                                                                    }
                                                                    else
                                                                    {
                                                                        echo"
                                                                            <option value='".$d_mentor_kind['name_mentor_kind']."'>".$d_mentor_kind['name_mentor_kind']."</option>
                                                                            ";
                                                                    }
                                                                }
                                                                echo"</select>";
                                                            ...
                                                            <?php
                                                            $sql_mentor_edu="SELECT * FROM tb_mentor_edu order by name_mentor_edu ASC";
                                
                                                            $q_mentor_edu=$conn->query($sql_mentor_edu);
                                                            $r_mentor_edu=$q_mentor_edu->rowCount();

                                                            if($r_mentor_edu>0)
                                                            {
                                                                echo "<select name='min_mentor_rsj'>";
                                                                while($d_mentor_edu=$q_mentor_edu->fetch(PDO::FETCH_ASSOC))
                                                                {
                                                                    if(strtolower($d_mentor_edu['name_mentor_edu'])==strtolower($d_mentor_rsj['min_mentor_rsj']))
                                                                    {
                                                                        echo"
                                                                            <option selected value='".$d_mentor_edu['name_mentor_edu']."'>".$d_mentor_edu['name_mentor_edu']."</option>
                                                                            ";  
                                                                    }
                                                                    else
                                                                    {
                                                                        echo"
                                                                            <option value='".$d_mentor_edu['name_mentor_edu']."'>".$d_mentor_edu['name_mentor_edu']."</option>
                                                                            ";
                                                                    }
                                                                }
                                                                echo"</select>";
