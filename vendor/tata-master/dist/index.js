  ...
  function o(e) {
    ...
    var r = function (r) {
      return (
        n.hot.active
          ? (M[r]
              ? M[r].parents.indexOf(e) < 0 && M[r].parents.push(e)
              : ((D = [e]), (y = r)),
            n.children.indexOf(r) < 0 && n.children.push(r))
          : (console.warn(
  ...
  function u() {
    ...
    if (((v = null), e))
      if (b)
        ...
        var n = [];
        for (var r in m)
          Object.prototype.hasOwnProperty.call(m, r) && n.push(d(r));
        e.resolve(n);
      }
  }
  function p(r) {
    ...
    var o,
      ...
      y = function () {
        console.warn(
          "[HMR] unexpected require(" + b.moduleId + ") to disposed module"
        );
      };
    for (var v in m)
      if (Object.prototype.hasOwnProperty.call(m, v)) {
        ...
        switch (
          ...
          case "self-declined":
            r.onDeclined && r.onDeclined(b),
              r.ignoreDeclined ||
                (O = new Error(
                  "Aborted because of self decline: " + b.moduleId + x
                ));
            break;
          case "declined":
            r.onDeclined && r.onDeclined(b),
            ...
            break;
          case "unaccepted":
            r.onUnaccepted && r.onUnaccepted(b),
              r.ignoreUnaccepted ||
                (O = new Error(
                  "Aborted because " + l + " is not accepted" + x
                ));
            break;
          case "accepted":
        ...
        if (E) {
          ...
          for (l in b.outdatedDependencies)
            Object.prototype.hasOwnProperty.call(b.outdatedDependencies, l) &&
    ...
    for (c = 0; c < p.length; c++)
      (l = p[c]),
        M[l] &&
          M[l].hot._selfAccepted &&
          H.push({ module: l, errorHandler: M[l].hot._selfAccepted });
    i("dispose"),
    ...
    for (var P, A = p.slice(); A.length > 0; )
      if (((l = A.pop()), (s = M[l]))) {
        ...
        for (
          _[l] = q, s.hot.active = !1, delete M[l], delete u[l], a = 0;
          a < s.children.length;
          a++
        ) {
    ...
    for (l in u)
      if (Object.prototype.hasOwnProperty.call(u, l) && (s = M[l]))
        for (L = u[l], a = 0; a < L.length; a++)
          (U = L[a]),
            (P = s.children.indexOf(U)) >= 0 && s.children.splice(P, 1);
    i("apply"), (w = g);
