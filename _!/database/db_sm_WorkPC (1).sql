...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Feb 2022 pada 04.15
...
CREATE TABLE `tb_praktik` (
  ...
  `nama_pj_praktik` text NOT NULL,
  `email_pj_praktik` text NOT NULL,
  `telp_pj_praktik` text NOT NULL,
...
INSERT INTO `tb_praktik` (`id_praktik`, `id_mou`, `id_institusi`, `id_mentor`, `id_unit`, `nama_praktik`, `tgl_input_praktik`, `tgl_ubah_praktik`, `tgl_mulai_praktik`, `tgl_selesai_praktik`, `jumlah_praktik`, `surat_praktik`, `data_praktik`, `id_jurusan_pdd_jenis`, `id_jurusan_pdd`, `id_jenjang_pdd`, `id_spesifikasi_pdd`, `id_akreditasi`, `id_user`, `nama_pj_praktik`, `email_pj_praktik`, `telp_pj_praktik`, `status_cek_praktik`, `status_praktik`, `ket_tolak_praktik`) VALUES
(1, 0, 54, NULL, NULL, 'Velit quia nulla ex ', '2022-02-21', NULL, '1985-06-18', '2013-01-11', 41, './_file/praktik/surat_1_2022-02-21.pdf', './_file/praktik/data_praktikan_1_2022-02-21.xlsx', 0, '2', '7', '2', '3', '1', 'Sed corrupti atque ', 'gozydem@mailinator.com', '84', 'DPT', '', ''),
(2, 0, 14, NULL, NULL, 'Explicabo Exercitat', '2022-02-21', NULL, '1992-07-01', '2017-08-13', 63, './_file/praktik/surat_2_2022-02-21.pdf', './_file/praktik/data_praktikan_2_2022-02-21.xlsx', 0, '1', '7', '0', '2', '1', 'Cumque dolor laborum', 'livavo@mailinator.com', '53', 'DPT', '', ''),
(3, 0, 19, NULL, NULL, 'Animi voluptates et', '2022-02-21', NULL, '2003-09-24', '2018-11-06', 38, './_file/praktik/surat_3_2022-02-21.pdf', './_file/praktik/data_praktikan_3_2022-02-21.xlsx', 2, '2', '8', '15', '2', '1', 'Eos incidunt aliqu', 'lukyjyty@mailinator.com', '54', 'DPT', '', '');
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-02-21', '2021-03-29', '2022-02-21', 'Y'),
