...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2022 at 12:56 PM
...
CREATE TABLE `tb_tarif` (
  ...
  `frekuensi_tarif` int(11) DEFAULT NULL,
...
INSERT INTO `tb_tarif` (`id_tarif`, `nama_tarif`, `id_tarif_satuan`, `ket_tarif`, `jumlah_tarif`, `frekuensi_tarif`, `tipe_tarif`, `id_jurusan_pdd_jenis`, `id_jurusan_pdd`, `id_jenjang_pdd`, `id_spesifikasi_pdd`, `id_tarif_jenis`, `pilih_tarif`, `tgl_tarif`) VALUES
...
CREATE TABLE `tb_tarif_pilih` (
  ...
  `jumlah_tarif_pilih` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `tb_tarif`
  MODIFY `id_tarif` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
