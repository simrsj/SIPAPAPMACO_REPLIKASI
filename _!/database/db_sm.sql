...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2022 at 12:39 AM
...
(2, 0, 45, NULL, NULL, 'Kelompok 1', '2022-02-13', NULL, '2003-01-23', '2004-07-01', 12, './_file/praktik/surat_2_2022-02-13.pdf', './_file/praktik/data_praktikan_2_2022-02-13.xlsx', '2', '8', '0', '2', '1', 'Quis blanditiis poss', 'gadu@mailinator.com', '84', 'VPH_Y', 'D', '', 0);
...
(1, 'Aula Utama', 40, 2, 1000000, 7, '2022-02-13', '-', 'y'),
(2, 'Aula Utama', 40, 3, 1000000, 7, '2022-02-13', '-', 'y'),
(3, 'Aula Utama', 40, 4, 1000000, 7, '2022-02-13', '-', 'y'),
(4, 'Aula Napza', 40, 2, 750000, 7, '2022-02-13', '-', 'y'),
(5, 'Aula Napza', 40, 3, 750000, 7, '2022-02-13', '-', 'y'),
(6, 'Aula Napza', 40, 4, 750000, 7, '2022-02-13', '-', 'y'),
(7, 'Ruang SPI', 20, 2, 500000, 7, '2022-02-13', '-', 'y'),
(8, 'Ruang SPI', 20, 3, 0, 7, '2022-02-13', '-', 'y'),
...
CREATE TABLE `tb_tempat_pilih` (
  ...
  `id_tempat` int(11) NOT NULL,
  `id_praktik` int(11) NOT NULL,
  `tgl_input_tempat_pilih` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-02-13', '2021-03-29', '2022-01-17', 'Y'),
...
--
ALTER TABLE `tb_harga_pilih`
  MODIFY `id_harga_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `tb_mess`
  MODIFY `id_mess` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
