...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Feb 2022 pada 10.49
...
(10, 2, 3, '2022-02-10', NULL, 1, 10, 50000),
(11, 2, 1, '2022-02-10', NULL, 1, 10, 500000),
(12, 2, 2, '2022-02-10', NULL, 1, 10, 750000),
(13, 2, 4, '2022-02-10', NULL, 1, 10, 50000),
(14, 2, 6, '2022-02-10', NULL, 1, 10, 200000),
(15, 2, 7, '2022-02-10', NULL, 1, 10, 50000),
(16, 2, 5, '2022-02-10', NULL, 1, 10, 100000),
(17, 2, 13, '2022-02-10', NULL, 1, 10, 375000),
(18, 2, 10, '2022-02-10', NULL, 1, 10, 375000),
(19, 2, 9, '2022-02-10', NULL, 1, 10, 375000),
(20, 2, 8, '2022-02-10', NULL, 1, 10, 375000),
(21, 2, 11, '2022-02-10', NULL, 1, 10, 375000),
(22, 2, 12, '2022-02-10', NULL, 1, 10, 375000),
(23, 2, 15, '2022-02-10', NULL, 1, 10, 1500000),
(24, 2, 16, '2022-02-10', NULL, 1, 10, 200000),
(25, 2, 17, '2022-02-10', NULL, 1, 10, 1000000);
...
CREATE TABLE `tb_praktik` (
  ...
  `ket_tolakPembayaran_praktik` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 0, 15, NULL, NULL, 'Minim quia non quaer', '2022-02-09', NULL, '2020-09-09', '2323-09-24', 6, './_file/praktik/surat_1_2022-02-09.pdf', './_file/praktik/data_praktikan_1_2022-02-09.xlsx', '2', '8', '0', '3', '1', 'A omnis nulla in dol', 'haxacutid@mailinator.com', '15', 'VPH_Y', 'D', 'Spesifikasi Praktik Tidak Sesuai', 0),
(2, 0, 67, NULL, NULL, 'Kelompok 1', '2022-02-10', NULL, '2009-03-23', '2010-08-19', 10, './_file/praktik/surat_2_2022-02-10.pdf', './_file/praktik/data_praktikan_2_2022-02-10.xlsx', '1', '8', '1', '2', '1', 'Deserunt labore nisi', 'nywudabog@mailinator.com', '13', 'DPH', 'D', '', 0);
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-02-10', '2021-03-29', '2022-01-17', 'Y'),
...
--
ALTER TABLE `tb_harga_pilih`
  MODIFY `id_harga_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
