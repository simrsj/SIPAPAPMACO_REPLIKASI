...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Feb 2022 pada 10.00
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-02-09', '2021-03-29', '2022-01-17', 'Y'),
...
--
ALTER TABLE `tb_harga_pilih`
  MODIFY `id_harga_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
