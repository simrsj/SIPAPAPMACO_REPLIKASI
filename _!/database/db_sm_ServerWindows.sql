...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Feb 2022 pada 10.21
...
(1, NULL, 1, 'asd', 'asd', 'asd', '2022-02-21', './_file/bayar/bayar_1_1-2022-02-21.pdf');
...
CREATE TABLE `tb_mess` (
  ...
  `alamat_mess` text,
  `nama_pemilik_mess` text,
  `no_pemilik_mess` text,
  `email_pemilik_mess` text,
...
(1, 1, 1, '2022-02-21', 'y', 365, 365000000),
(2, 2, 1, '2022-02-21', 'y', 258, 593400000);
...
(1, 0, 35, NULL, NULL, 'Nemo nobis minus com', '2022-02-21', NULL, '2006-10-08', '2007-10-07', 10, './_file/praktik/surat_1_2022-02-21.pdf', './_file/praktik/data_praktikan_1_2022-02-21.xlsx', 2, '2', '2', '0', '2', '1', 'Molestiae adipisci a', 'herul@mailinator.com', '93', 'SLS', 'Y', ''),
(2, 0, 6, NULL, NULL, 'Minima error eum par', '2022-02-21', NULL, '2008-07-03', '2009-03-17', 23, './_file/praktik/surat_2_2022-02-21.pdf', './_file/praktik/data_praktikan_2_2022-02-21.xlsx', 1, '1', '5', '2', '1', '1', 'Ut quia eaque nostru', 'rewur@mailinator.com', '17', 'MESS', 'D', '');
...
INSERT INTO `tb_tarif` (`id_tarif`, `nama_tarif`, `id_tarif_satuan`, `ket_tarif`, `jumlah_tarif`, `tipe_tarif`, `id_jurusan_pdd_jenis`, `id_jurusan_pdd`, `id_jenjang_pdd`, `id_spesifikasi_pdd`, `id_tarif_jenis`, `pilih_tarif`, `tgl_tarif`) VALUES
...
INSERT INTO `tb_tarif_pilih` (`id_tarif_pilih`, `id_praktik`, `id_tarif`, `tgl_input_tarif_pilih`, `tgl_ubah_tarif_pilih`, `frekuensi_tarif_pilih`, `kuantitas_tarif_pilih`, `jumlah_tarif_pilih`) VALUES
(1, 1, 18, '2022-02-21', NULL, 1, 10, 500000),
(2, 1, 19, '2022-02-21', NULL, 1, 10, 750000),
(3, 1, 20, '2022-02-21', NULL, 1, 10, 200000),
(4, 1, 22, '2022-02-21', NULL, 1, 10, 1500000),
(5, 1, 23, '2022-02-21', NULL, 1, 10, 200000),
(6, 1, 24, '2022-02-21', NULL, 1, 10, 100000),
(7, 1, 21, '2022-02-21', NULL, 1, 10, 750000),
(8, 1, 26, '2022-02-21', NULL, 3, 10, 4500000),
(9, 1, 25, '2022-02-21', NULL, 1, 10, 1500000),
(10, 1, 27, '2022-02-21', NULL, 1, 10, 1500000),
(11, 1, 28, '2022-02-21', NULL, 1, 10, 200000),
(12, 1, 29, '2022-02-21', NULL, 1, 10, 1000000),
(13, 1, 30, '2022-02-21', NULL, 1, 10, 1500000),
(14, 1, 31, '2022-02-21', NULL, 1, 10, 200000),
(15, 2, 3, '2022-02-21', NULL, 1, 23, 115000),
(16, 2, 1, '2022-02-21', NULL, 1, 23, 1150000),
(17, 2, 2, '2022-02-21', NULL, 1, 23, 1725000),
(18, 2, 4, '2022-02-21', NULL, 1, 23, 115000),
(19, 2, 6, '2022-02-21', NULL, 1, 23, 460000),
(20, 2, 7, '2022-02-21', NULL, 1, 23, 115000),
(21, 2, 5, '2022-02-21', NULL, 1, 23, 230000),
(22, 2, 13, '2022-02-21', NULL, 1, 23, 862500),
(23, 2, 10, '2022-02-21', NULL, 1, 23, 862500),
(24, 2, 9, '2022-02-21', NULL, 1, 23, 862500),
(25, 2, 8, '2022-02-21', NULL, 1, 23, 862500),
(26, 2, 11, '2022-02-21', NULL, 1, 23, 862500),
(27, 2, 12, '2022-02-21', NULL, 1, 23, 862500),
(28, 2, 15, '2022-02-21', NULL, 1, 23, 3450000),
(29, 2, 16, '2022-02-21', NULL, 1, 23, 460000),
(30, 2, 17, '2022-02-21', NULL, 1, 23, 2300000);
...
INSERT INTO `tb_tempat_pilih` (`id_tempat_pilih`, `id_tempat`, `id_praktik`, `frek_tempat_pilih`, `kuan_tempat_pilih`, `total_tarif_tempat_pilih`, `tgl_input_tempat_pilih`) VALUES
(1, 1, 1, 1, 1, 1000000, '2022-02-21'),
(2, 10, 2, 23, 258, 178020000, '2022-02-21');
...
(1, 0, 0, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-01-10', '2021-03-29', '2022-01-02', 'Y'),
