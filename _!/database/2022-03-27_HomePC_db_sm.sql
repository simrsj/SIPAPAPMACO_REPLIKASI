...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2022 at 06:55 PM
...
(6, 0, 88, NULL, NULL, 'Kelompok 1', '2022-03-25', NULL, '2022-03-25', '2022-04-26', 7, '54/134/123', './_file/praktik/surat_6_2022-03-25.pdf', './_file/praktik/data_praktikan_6_2022-03-25.xlsx', 4, '4', '8', '0', '', '1', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '08123145645', 'MESS', 'D', '', '', 'y', 't', 't', NULL),
(7, 0, 48, NULL, NULL, 'Harum id praesentiu', '2022-03-26', NULL, '2022-03-26', '2022-03-29', 7, '/123123/123123', './_file/praktik/surat_7_2022-03-26.pdf', './_file/praktik/data_praktikan_7_2022-03-26.xlsx', 2, '2', '9', '5', '', '1', 'Magni vel dolor offi', 'fily@mailinator.com', '20', 'AKV', 'Y', '', '', 'y', 'y', 'y', './_file/inv/inv_7_2022-03-27.pdf');
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-03-27', '2021-03-29', '2022-02-22', 'Y'),
...
--
ALTER TABLE `tb_praktikan`
  MODIFY `id_praktikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;

--
-- AUTO_INCREMENT for table `tb_praktik_tgl`
--
ALTER TABLE `tb_praktik_tgl`
  MODIFY `id_praktik_tgl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `tb_tarif_pilih`
  MODIFY `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
