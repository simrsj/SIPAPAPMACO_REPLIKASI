...
(2, 2, '2022-12-31', '2022-12-31', 'Biaya Overhead Operational', 'Ut blanditiis impedi', 5, 'per-orang / penguji', 53, 69, 18285, NULL, NULL, 'Y');
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', 1, '08123145645', NULL, '2023-01-03 03:23:35', '2021-03-29', '2022-02-22', NULL, 'Y'),
...
--
ALTER TABLE `tb_tarif_satuan`
  MODIFY `id_tarif_satuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
