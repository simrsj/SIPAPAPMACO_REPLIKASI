...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2022 at 10:38 AM
...
(1, 5, 1, '2022-11-21', NULL, 6, 120000);
...
CREATE TABLE `tb_praktik` (
  ...
  `status_mess_praktik` enum('T','Y') DEFAULT NULL COMMENT 'stasus pakai mess ',
  ...
  `status_bayar_praktik` enum('T','Y') DEFAULT NULL COMMENT 'Status Pembayaran Praktik',
...
INSERT INTO `tb_praktik` (`id_praktik`, `id_user`, `id_mou`, `id_institusi`, `id_jurusan_pdd_jenis`, `id_jurusan_pdd`, `id_jenjang_pdd`, `id_profesi_pdd`, `nama_praktik`, `tgl_input_praktik`, `tgl_ubah_praktik`, `tgl_mulai_praktik`, `tgl_selesai_praktik`, `jumlah_praktik`, `no_surat_praktik`, `surat_praktik`, `data_praktik`, `nama_koordinator_praktik`, `email_koordinator_praktik`, `telp_koordinator_praktik`, `status_praktik`, `status_mess_praktik`, `status_pembimbing_praktik`, `status_tarif_praktik`, `status_bayar_praktik`, `makan_mess_praktik`, `materi_upip_praktik`, `materi_napza_praktik`, `fileInv_praktik`, `fileNilKep_praktik`) VALUES
(1, '1', 0, 11, 3, '5', '', '', '', '2022-11-14', NULL, '2022-11-14', '2022-12-14', 0, 'Iste dolorem volupta', './_file/praktik/surat_1_2022-11-14.pdf', '', '', '', '', 'Y', NULL, 'T', '', 'T', NULL, NULL, NULL, NULL, NULL),
(2, '1', 0, 11, 3, '3', '9', '4', '', '2022-11-14', NULL, '2022-11-14', '2022-12-14', 0, 'Quo commodo qui ut o', './_file/praktik/3d1c9046adf84f240c7ae28c389b36c1.pdf', NULL, '', '', '', 'Y', NULL, 'T', '', 'T', NULL, NULL, NULL, NULL, NULL),
(3, '1', 0, 11, 3, '3', '', '', 'Vel cupidatat id eos', '2022-11-14', NULL, '2022-11-14', '2022-12-14', 12, 'Quo commodo qui ut o', './_file/praktik/3d1c9046adf84f240c7ae28c389b36c1.pdf', NULL, 'Quasi rerum laborum', 'mufoqyxu@mailinator.com', '41', 'Y', NULL, 'T', '', 'T', NULL, NULL, NULL, NULL, NULL),
(4, '1', 0, 11, 3, '5', '9', '3', 'Vel cupidatat id eos', '2022-11-14', NULL, '2022-11-14', '2022-12-14', 12, 'Quo commodo qui ut o', './_file/praktik/3d1c9046adf84f240c7ae28c389b36c1.pdf', NULL, 'Quasi rerum laborum', 'mufoqyxu@mailinator.com', '41', 'Y', NULL, 'T', '', 'T', NULL, NULL, NULL, NULL, NULL),
(5, '1', 0, 1, 1, '1', '9', '1', 'asd', '2022-11-15', NULL, '2022-11-15', '2022-11-20', 12, '123', './_file/praktik/724393b04a3b1f274128592e6143227f.pdf', NULL, 'ADMIN DIKLAT RS JIWA', 'admin@admin', '08123145645', 'Y', 'Y', 'T', '', NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 5, '2022-11-21', NULL, 'Pemakaian Kekayaan Daerah', 'Mess RSJ 1 Lama', 20000, 'per-siswa / hari', 6, 12, 120000, NULL, 'Y');
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', 1, '08123145645', NULL, '2022-11-21 2:04:28', '2021-03-29', '2022-02-22', NULL, 'Y'),
...
INSERT INTO `tb_user_privileges` (`id_user`, `c_kuota`, `r_kuota`, `u_kuota`, `d_kuota`, `c_akun`, `r_akun`, `u_akun`, `d_akun`, `c_praktik`, `r_praktik`, `u_praktik`, `d_praktik`, `c_praktik_mess`, `r_praktik_mess`, `u_praktik_mess`, `d_praktik_mess`, `c_narsum`, `r_narsum`, `u_narsum`, `d_narsum`) VALUES
