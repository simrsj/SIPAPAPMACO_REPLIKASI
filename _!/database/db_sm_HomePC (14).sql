...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2022 at 05:33 AM
...
(1, NULL, 1, 'B1220227', 'Sint nemo incididun', 'Veniam optio quisq', 'Optio architecto am', '2000-12-13', '2022-02-27', './_file/bayar/bayar_1_1_2022-02-27.pdf'),
(2, NULL, 2, 'B2220227', 'Cumque Nam eum qui p', 'Vel non tempore vol', 'Molestias quae in od', '2002-04-08', '2022-02-28', './_file/bayar/bayar_2_2_2022-02-28.pdf'),
(3, NULL, 2, 'B2220227', 'Lorem ut aut harum q', 'Ut dicta enim volupt', 'Eius assumenda assum', '2022-02-28', '2022-02-28', './_file/bayar/bayar_3_2_2022-02-28.pdf');
...
(1, 1, 1, '2022-02-27', 't', 12654, 10629360000),
(2, 2, 1, '2022-02-27', 'y', 8585, 82416000000),
(3, 3, 2, '2022-02-28', 'y', 10341, 103410000000);
...
(1, 0, 42, NULL, NULL, 'Et sunt nobis animi', '2022-02-27', NULL, '1974-11-18', '2009-07-10', 42, 'Ratione voluptatem o', './_file/praktik/surat_1_2022-02-27.pdf', './_file/praktik/data_praktikan_1_2022-02-27.xlsx', 2, '2', '8', '1', '0', '1', 'Velit voluptatum ips', 'wariledas@mailinator.com', '42', 'SLS', 'Y', '', '', 't', 'y', 'y'),
(2, 0, 73, NULL, NULL, 'Aliqua Nulla est qu', '2022-02-27', NULL, '1978-05-14', '2001-11-13', 96, 'Corporis voluptatem', './_file/praktik/surat_2_2022-02-27.pdf', './_file/praktik/data_praktikan_2_2022-02-27.xlsx', 1, '1', '8', '0', '1', '1', 'Eius et omnis commod', 'gice@mailinator.com', '82', 'SLS', 'W', '18000', '', '', 't', 't'),
(3, 0, 31, NULL, NULL, 'Quo est fugiat non ', '2022-02-28', NULL, '1992-12-21', '2021-04-13', 100, 'Officia qui voluptat', './_file/praktik/surat_3_2022-02-28.pdf', './_file/praktik/data_praktikan_3_2022-02-28.xlsx', 1, '1', '10', '2', '2', '1', 'Omnis deleniti ut vo', 'qylabe@mailinator.com', '61', 'MESS', 'D', '', '', 'y', 't', 't'),
(4, 0, 47, NULL, NULL, 'Consequuntur non off', '2022-02-28', NULL, '1999-07-16', '2001-11-02', 53, 'Voluptatem Suscipit', './_file/praktik/surat_4_2022-02-28.pdf', './_file/praktik/data_praktikan_4_2022-02-28.xlsx', 1, '1', '10', '1', '0', '1', 'Minus ea ipsum sit ', 'soxipovox@mailinator.com', '49', 'DPT_KED', 'D', '', '', 'y', 't', 't');
...
(1, 1, '2022-02-27', NULL, 'Administrasi', 'Institusional Fee', 50000, 'persiswa/periode', 1, 42, 2100000),
(2, 1, '2022-02-27', NULL, 'Administrasi', 'Management Fee', 75000, 'persiswa/periode', 1, 42, 3150000),
(3, 1, '2022-02-27', NULL, 'Barang Habis Pakai', 'Untuk Keselamatan Kerja (Handrub, tisue, sabun)', 20000, 'persiswa/periode', 1, 42, 840000),
(4, 1, '2022-02-27', NULL, 'Overhead Operational', 'Keselamatan Pasien', 150000, 'perperiode/kali', 1, 42, 6300000),
(5, 1, '2022-02-27', NULL, 'Overhead Operational', 'Log Book (dibayar 1 kali)', 20000, 'persiswa/periode', 1, 42, 840000),
(6, 1, '2022-02-27', NULL, 'Overhead Operational', 'Name Tag (dibayar 1 kali)', 10000, 'persiswa/periode', 1, 42, 420000),
(7, 1, '2022-02-27', NULL, 'Overhead Operational', 'Orientasi ', 75000, 'perperiode/kali', 1, 1, 75000),
(8, 1, '2022-02-27', NULL, 'Pembelajaran', 'Materi (TAK, Komunikasi Terapeutik, Dokumentasi Keperawatanan, UPIP, NAPZA)', 150000, 'perperiode/kali', 5, 1, 750000),
(9, 1, '2022-02-27', NULL, 'Pembelajaran', 'RPS (Resource Person Session)', 150000, 'perperiode/kali', 1, 42, 6300000),
(10, 1, '2022-02-27', NULL, 'Pembelajaran', 'Bed side teaching (BST)', 75000, 'persiswa/minggu', 1807, 42, 5692050000),
(11, 1, '2022-02-27', NULL, 'Ujian', 'Ujian', 150000, 'persiswa/hari', 1, 42, 6300000),
(12, 1, '2022-02-27', NULL, 'Ujian', 'Makan dan Snack Penguji', 20000, 'perpenguji/kali', 1, 42, 840000),
(13, 1, '2022-02-27', NULL, 'Ujian', 'Bahan Habis Pakai Ujian', 100000, 'persiswa/kali', 1, 42, 4200000),
(14, 1, '2022-02-27', NULL, 'Ujian', 'Institusional Fee Ujian', 150000, 'persiswa/periode ujian', 1, 42, 6300000),
(15, 1, '2022-02-27', NULL, 'Ujian', 'Management Fee Ujian', 20000, 'persiswa/periode ujian', 1, 42, 840000),
(16, 1, '2022-02-27', NULL, 'Pemakaian Kekayaan Daerah', 'Aula Napza', 750000, 'perperiode/kali', 1, 1, 750000),
(20, 1, '2022-02-27', NULL, 'Mess/Pemondokan', 'Mess RSJ 1 Lama (Tanpa Makan)', 20000, 'persiswa/hari', 12654, 42, 10629360000),
(21, 2, '2022-02-27', NULL, 'Mess/Pemondokan', 'Mess RSJ 1 Lama (Dengan Makan 3x Sehari)', 100000, 'persiswa/hari', 8585, 96, 82416000000),
(22, 3, '2022-02-28', NULL, 'Mess/Pemondokan', 'Mess RSJ 2 Baru (Dengan Makan 3x Sehari)', 100000, 'persiswa/hari', 10341, 100, 103410000000),
(23, 2, '2022-02-28', NULL, 'Administrasi', 'Alat Tulis Kantor', 5000, 'persiswa/periode', 65, 17, 5525000),
(24, 2, '2022-02-28', NULL, 'Administrasi', 'Institusional Fee', 50000, 'persiswa/periode', 96, 90, 432000000),
(25, 2, '2022-02-28', NULL, 'Administrasi', 'Management Fee', 75000, 'persiswa/periode', 93, 40, 279000000),
(26, 2, '2022-02-28', NULL, 'Barang Habis Pakai', 'Untuk Keselamatan Kerja (Handrub, tisue, sabun)', 5000, 'persiswa/periode', 68, 32, 10880000),
(27, 2, '2022-02-28', NULL, 'Overhead Operational', 'Log Book (dibayar 1 kali)', 20000, 'persiswa/periode', 63, 48, 60480000),
(28, 2, '2022-02-28', NULL, 'Overhead Operational', 'Name Tag (dibayar 1 kali)', 5000, 'persiswa/periode', 87, 37, 16095000),
(29, 2, '2022-02-28', NULL, 'Overhead Operational', 'Orientasi Keselamatan Pasien', 10000, 'persiswa/periode', 75, 72, 54000000),
(30, 2, '2022-02-28', NULL, 'Pembelajaran', 'Bed side teaching (BST)- Visite Besar-Role Model - Pembimbingan Kedokteran Umum di IGD', 37500, 'persiswa/kali', 10, 79, 29625000),
(31, 2, '2022-02-28', NULL, 'Pembelajaran', 'Case base Discusion (CBD)', 37500, 'persiswa/kali', 73, 34, 93075000),
(32, 2, '2022-02-28', NULL, 'Pembelajaran', 'Case report session (CRS)', 37500, 'persiswa/kali', 68, 77, 196350000),
(33, 2, '2022-02-28', NULL, 'Pembelajaran', 'Clinical science session (CSS)', 37500, 'persiswa/kali', 29, 90, 97875000),
(34, 2, '2022-02-28', NULL, 'Pembelajaran', 'Pengayaan - Observasi', 37500, 'persiswa/kali', 45, 26, 43875000),
(35, 2, '2022-02-28', NULL, 'Pembelajaran', 'RPS (Resource Person Session)', 37500, 'persiswa/kali', 3, 73, 8212500),
(36, 2, '2022-02-28', NULL, 'Ujian', 'Mini Clinical Examination  Evaluation (Mini CeX)', 150000, 'persiswa/kali', 70, 51, 535500000),
(37, 2, '2022-02-28', NULL, 'Ujian', 'Ujian', 150000, 'persiswa/kali', 6, 40, 36000000),
(38, 2, '2022-02-28', NULL, 'Ujian', 'Makan Pembimbing Ujian', 20000, 'persiswa/kali', 34, 28, 19040000),
(39, 2, '2022-02-28', NULL, 'Ujian', 'Standar Pasien', 100000, 'persiswa/kali', 68, 46, 312800000),
(40, 2, '2022-02-28', NULL, 'Pemakaian Kekayaan Daerah', 'Ruang Kelas/Ruang Diskusi', 30000, 'persiswa/hari', 73, 34, 74460000);
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-02-27', '2021-03-29', '2022-02-22', 'Y'),
...
--
ALTER TABLE `tb_tarif_pilih`
  MODIFY `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
