...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2022 at 02:19 PM
...
--
  ...
  --
INSERT INTO
  `tb_akreditasi` (`id_akreditasi`, `nama_akreditasi`)
VALUES
  (1, '-- Lainnya --'),
  (2, 'A'),
  (3, 'B'),
...
VALUES
  (
    ...
    '1979-07-15',
    '2022-03-01',
    './_file/bayar/bayar_1_1_2022-03-01.pdf'
  ),
  (
    2,
    NULL,
    ...
    'Pariatur In aliquid',
    'Magna vero fugiat l',
    'Dolore adipisicing l',
    '2022-10-01',
    '2022-03-01',
    './_file/bayar/bayar_2_1_2022-03-01.pdf'
  ),
  (
    3,
    NULL,
    4,
    'B4220303',
    'Corporis a ad volupt',
    'Aliquam irure illum',
    'Nisi corporis offici',
    '2022-03-01',
    '2022-03-03',
    './_file/bayar/bayar_3_4_2022-03-03.pdf'
  );
-- --------------------------------------------------------
  --
...
--
  ...
  --
INSERT INTO
  `tb_jenis_mentor` (`id_jenis_mentor`, `nama_jenis_mentor`)
VALUES
  (1, 'CI'),
  (2, 'CIL'),
  (3, 'PPDS'),
...
--
  ...
  --
INSERT INTO
  `tb_jenjang_pdd` (`id_jenjang_pdd`, `nama_jenjang_pdd`)
VALUES
  (0, '-- Lainnya --'),
  (1, 'SMA'),
  (2, 'SMK'),
...
--
  ...
  --
INSERT INTO
  `tb_jurusan_pdd_jenis` (`id_jurusan_pdd_jenis`, `nama_jurusan_pdd_jenis`)
VALUES
  (0, '-- Lainnya --'),
  (1, 'Kedokteran'),
  (2, 'Keperawatan'),
...
--
  ...
  --
INSERT INTO
  `tb_jurusan_pdd_profesi` (
    `id_jurusan_pdd_profesi`,
    `id_jurusan_pdd`,
    `id_profesi_pdd`
  )
VALUES
...
VALUES
  ...
  (
    2,
    '197905022005012012',
    'Aam Amalia, S.Kep., Ners (Struktural)',
    '0',
    1,
    8,
    'y',
...
--
  ...
  --
INSERT INTO
  `tb_pembimbing_jenis` (`id_pembimbing_jenis`, `nama_pembimbing_jenis`)
VALUES
  (1, 'CI'),
  (2, 'CIL'),
  (3, 'PSPD'),
...
VALUES
  (
    ...
    91,
    'Pariatur Quo rem vo',
    './_file/praktik/surat_1_2022-03-01.pdf',
    './_file/praktik/data_praktikan_1_2022-03-01.xlsx',
    2,
    '2',
    '10',
    '5',
  ...
  (
    ...
    NULL,
    NULL,
    'Ipsum quo voluptatem',
    '2022-03-03',
    NULL,
    '1977-11-07',
    '1999-01-21',
    65,
    'Cupiditate magnam in',
    './_file/praktik/surat_3_2022-03-03.pdf',
    './_file/praktik/data_praktikan_3_2022-03-03.xlsx',
    2,
    '2',
    '10',
    '5',
  ...
  (
    ...
    NULL,
    NULL,
    'Quo quia ullam ullam',
    '2022-03-03',
    NULL,
    '2022-03-03',
    '2022-03-19',
    14,
    'Ex ipsam consequatur',
    './_file/praktik/surat_4_2022-03-03.pdf',
    './_file/praktik/data_praktikan_4_2022-03-03.xlsx',
    2,
    '2',
    '10',
    '5',
    '3',
    '1',
    'Quaerat dolorem maio',
    'majybabehe@mailinator.com',
    '33',
    'AKV',
    'Y',
    '',
...
--
  ...
  --
INSERT INTO
  `tb_profesi_pdd` (`id_profesi_pdd`, `nama_profesi_pdd`)
VALUES
  (0, '-- Lainnya --'),
...
--
  ...
  --
INSERT INTO
  `tb_tarif_jenis` (`id_tarif_jenis`, `nama_tarif_jenis`)
VALUES
  (0, '-- Lainnya --'),
  (1, 'Administrasi'),
...
VALUES
  ...
  (
    ...
    NULL,
    'Pembelajaran',
    'Materi (TAK, Komunikasi Terapeutik, Dokumentasi Keperawatanan, UPIP, NAPZA)',
    150000,
    'perperiode/kali',
    5,
    1,
  ...
  (
    ...
    NULL,
    'Mess/Pemondokan',
    'Mess RSJ 1 Lama (Dengan Makan 3x Sehari)',
    100000,
    'persiswa/hari',
    10,
    91,
  ...
  (
    ...
    NULL,
    'Mess/Pemondokan',
    'Mess RSJ 2 Baru (Dengan Makan 3x Sehari)',
    100000,
    'persiswa/hari',
    17,
    14,
...
VALUES
  ...
  (
    ...
    5,
    'asalajah@gmail.com',
    'e66ed49f9432f4ef78d0910ab7e31f57',
    'Melly',
    'asalajah@gmail.com',
    '2',
    '081123456789',
  ...
  (
    ...
    0,
    3,
    'diklit.rsj.jabarprov@gmail.com',
    '39b1f688752f9edb7e1283a4649f05a4',
    'Rani',
    'diklit.rsj.jabarprov@gmail.com',
    '2',
    '081320510201',
...
ALTER TABLE
  `tb_jurusan_pdd_profesi`
ADD
  PRIMARY KEY (`id_jurusan_pdd_profesi`);
--
...
ALTER TABLE
  `tb_jenjang_pdd`
MODIFY
  `id_jenjang_pdd` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 19;
--
...
ALTER TABLE
  `tb_jurusan_pdd`
MODIFY
  `id_jurusan_pdd` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 7;
--
...
ALTER TABLE
  `tb_jurusan_pdd_jenis`
MODIFY
  `id_jurusan_pdd_jenis` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 6;
--
...
ALTER TABLE
  `tb_mess_detail`
MODIFY
  `id_mess_detail` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 12;
--
...
ALTER TABLE
  `tb_mess_pilih`
MODIFY
  `id_mess_pilih` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 3;
--
...
ALTER TABLE
  `tb_nilai_dokter`
MODIFY
  `id_nilai_dokter` int(100) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE
  `tb_pembimbing_jenis`
MODIFY
  `id_pembimbing_jenis` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 5;
--
...
ALTER TABLE
  `tb_pembimbing_pilih`
MODIFY
  `id_pembimbing_pilih` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE
  `tb_praktik`
MODIFY
  `id_praktik` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 5;
--
...
ALTER TABLE
  `tb_praktik_tgl`
MODIFY
  `id_praktik_tgl` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE
  `tb_profesi_pdd`
MODIFY
  `id_profesi_pdd` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 16;
--
...
ALTER TABLE
  `tb_tarif_jenis`
MODIFY
  `id_tarif_jenis` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 12;
--
...
ALTER TABLE
  `tb_tarif_pilih`
MODIFY
  `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 47;
--
...
ALTER TABLE
  `tb_tarif_satuan`
MODIFY
  `id_tarif_satuan` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 14;
--
...
ALTER TABLE
  `tb_tempat_pilih`
MODIFY
  `id_tempat_pilih` int(11) NOT NULL AUTO_INCREMENT;
--
