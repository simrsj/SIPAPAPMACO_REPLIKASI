...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2022 at 07:38 AM
...
INSERT INTO `tb_nilai_kep` (`id_nilai_kep`, `id_pembimbing`, `id_praktik`, `id_praktikan`, `lp`, `prepost`, `sptk`, `penkes`, `dokep`, `komter`, `tak`, `kasus`, `ujian`, `sikap`, `ket_nilai`) VALUES
(10, 24, 6, 5, '77', '62', '66', '40', '94', '73', '51', '49', '62', '77', 'Ipsum odio culpa mo'),
(11, 24, 6, 11, '5', '52', '61', '14', '57', '100', '15', '89', '40', '81', 'Consequuntur tenetur'),
(12, 24, 6, 6, '42', '58', '15', '72', '58', '64', '43', '65', '41', '36', 'Pariatur Quo except');
...
(1, 0, 9, NULL, NULL, 'Velit omnis exercita', '2022-03-01', NULL, '2022-03-01', '2022-03-10', 5, 'Pariatur Quo rem vo', './_file/praktik/surat_1_2022-03-01.pdf', './_file/praktik/data_praktikan_1_2022-03-01.xlsx', 2, '2', '10', '5', '3', '1', 'Ut cillum obcaecati ', 'sobaqary@mailinator.com', '80', 'SLS', 'S', '901203', '', 'y', 'y', 'y'),
...
(7, 0, 81, NULL, NULL, 'Consectetur excepte', '2022-03-08', NULL, '2013-01-17', '2014-10-20', 35, 'In accusamus modi ut', './_file/praktik/surat_7_2022-03-08.pdf', './_file/praktik/data_praktikan_7_2022-03-08.xlsx', 4, '4', '8', '0', '4', '1', 'Excepteur est iure s', 'bisydivyd@mailinator.com', '99', 'DPT', 'D', '', '', 'y', 't', 't');
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-03-08', '2021-03-29', '2022-02-22', 'Y'),
...
--
ALTER TABLE `tb_nilai_kep`
  MODIFY `id_nilai_kep` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tb_pembimbing_pilih`
--
ALTER TABLE `tb_pembimbing_pilih`
  MODIFY `id_pembimbing_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tb_praktikan`
  MODIFY `id_praktikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `tb_tarif_pilih`
  MODIFY `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
