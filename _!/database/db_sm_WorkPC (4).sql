...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Feb 2022 pada 10.06
...
INSERT INTO `tb_mess` (`id_mess`, `nama_mess`, `kapasitas_t_mess`, `alamat_mess`, `nama_pemilik_mess`, `no_pemilik_mess`, `email_pemilik_mess`, `tarif_tanpa_makan_mess`, `tarif_dengan_makan_mess`, `ket_mess`, `status_mess`) VALUES
(1, 'Mess RSJ 1 Lama', 20, 'Jl. Kolonel Maturi KM.7, Desa Jambudipa, Kec. Cisarua, Kab. Bandung Barat, 40551', 'RS Jiwa Provinsi Jawa Barat', '081321329101', '', 20000, 100000, 'Makan 3x Sehari', 'y'),
(2, 'Mess RSJ 2 Baru', 92, 'Jl. Kolonel Maturi KM.7, Desa Jambudipa, Kec. Cisarua, Kab. Bandung Barat, 40551', 'RS Jiwa Provinsi Jawa Barat', '081321329101', '', 20000, 100000, '', 'y'),
(3, 'Asrama Rifa Corporate', 100, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Ibu Ai', '081322629909', '', 20000, 80000, 'Dengan Makan 3x Sehari', 'y'),
(4, 'Pondokan H. Ating', 100, 'Kp. Barukai Timur RT. 04 RW. 13 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'H. Ating / Hj. Siti Sutiah', '0', '', 20000, 80000, '', 'y'),
(5, 'Wisma Anugrah Ibu Nanik', 70, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Hj. Nanik Susiani', '081320719652', '', 15000, 70000, '', 'y'),
(6, 'Pondokan dr. Hj. Meutia Laksminingrum', 0, '-', 'dr. Hj. Meutia Laksminingrum', '0', '', 0, 0, '', 't'),
(7, 'Galuh Pakuan', 70, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Oyo Suharya', '081320113399', '', 20000, 80000, '', 'y'),
(8, 'Pondokan Tatang', 30, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Tatang', '089531804825', '', 20000, 80000, 'Dengan Makan 3x Sehari', 'y');
...
(1, 0, 75, NULL, NULL, 'Ex reiciendis nemo e', '2022-02-23', NULL, '2019-04-10', '2020-08-24', 6, './_file/praktik/surat_1_2022-02-23.pdf', './_file/praktik/data_praktikan_1_2022-02-23.xlsx', 2, '2', '6', '0', '2', '1', 'Vero do rerum iure d', 'hequd@mailinator.com', '54', 'DPT', 'D', ''),
(2, 0, 82, NULL, NULL, 'Dolore et dolorem la', '2022-02-23', NULL, '2016-05-18', '2323-02-08', 63, './_file/praktik/surat_2_2022-02-23.pdf', './_file/praktik/data_praktikan_2_2022-02-23.xlsx', 4, '4', '4', '1', '3', '1', 'Doloribus sed facere', 'nezapo@mailinator.com', '72', 'DPT', 'D', ''),
(3, 0, 27, NULL, NULL, 'Consectetur dignissi', '2022-02-23', NULL, '1989-01-11', '2014-07-14', 33, './_file/praktik/surat_3_2022-02-23.pdf', './_file/praktik/data_praktikan_3_2022-02-23.xlsx', 2, '2', '8', '1', '0', '1', 'Et iste perspiciatis', 'fagujosozu@mailinator.com', '21', 'DPT', 'D', '');
...
(32, 'Bed side teaching (BST)', 2, NULL, 50000, 'MINGGUAN', 0, 0, 2, 6, 0, 4, 2, NULL, 'y'),
(33, 'Bed side teaching (BST)', 2, NULL, 75000, 'MINGGUAN', 0, 0, 2, 7, 0, 4, 2, NULL, 'y'),
(34, 'Bed side teaching (BST)', 2, NULL, 75000, 'MINGGUAN', 0, 0, 2, 8, 0, 4, 2, NULL, 'y'),
(35, 'Bed side teaching (BST)', 2, NULL, 75000, 'MINGGUAN', 0, 0, 2, 10, 0, 4, 2, NULL, 'y'),
...
(50, 'Bed side teaching (BST)', 2, NULL, 50000, 'MINGGUAN', 0, 0, 3, 6, 0, 4, 2, NULL, 'y'),
(51, 'Bed side teaching (BST)', 2, NULL, 75000, 'MINGGUAN', 0, 0, 3, 7, 0, 4, 2, NULL, 'y'),
(52, 'Bed side teaching (BST)', 2, NULL, 75000, 'MINGGUAN', 0, 0, 3, 8, 0, 4, 2, NULL, 'y'),
(53, 'Bed side teaching (BST)', 2, NULL, 75000, 'MINGGUAN', 0, 0, 3, 10, 0, 4, 2, NULL, 'y'),
...
(68, 'Bed side teaching (BST)', 2, NULL, 50000, 'MINGGUAN', 0, 0, 4, 6, 0, 4, 2, NULL, 'y'),
(69, 'Bed side teaching (BST)', 2, NULL, 75000, 'MINGGUAN', 0, 0, 4, 7, 0, 4, 2, NULL, 'y'),
(70, 'Bed side teaching (BST)', 2, NULL, 75000, 'MINGGUAN', 0, 0, 4, 8, 0, 4, 2, NULL, 'y'),
(71, 'Bed side teaching (BST)', 2, NULL, 75000, 'MINGGUAN', 0, 0, 4, 10, 0, 4, 2, NULL, 'y');
...
CREATE TABLE `tb_tarif_pilih` (
  ...
  `nama_tarif_jenis_pilih` text NOT NULL,
...
INSERT INTO `tb_tarif_pilih` (`id_tarif_pilih`, `id_praktik`, `tgl_input_tarif_pilih`, `tgl_ubah_tarif_pilih`, `nama_tarif_jenis_pilih`, `nama_tarif_pilih`, `nominal_tarif_pilih`, `frekuensi_tarif_pilih`, `kuantitas_tarif_pilih`, `jumlah_tarif_pilih`) VALUES
(1, 1, '2022-02-23', NULL, '', 'Institusional Fee', 50000, 1, 6, 300000),
(2, 1, '2022-02-23', NULL, '', 'Management Fee', 75000, 1, 6, 450000),
(3, 1, '2022-02-23', NULL, '', 'Untuk Keselamatan Kerja (Handrub, tisue, sabun)', 20000, 1, 6, 120000),
(4, 1, '2022-02-23', NULL, '', 'Keselamatan Pasien', 150000, 1, 6, 900000),
(5, 1, '2022-02-23', NULL, '', 'Log Book (dibayar 1 kali)', 20000, 1, 6, 120000),
(6, 1, '2022-02-23', NULL, '', 'Name Tag (dibayar 1 kali)', 10000, 1, 6, 60000),
(7, 1, '2022-02-23', NULL, '', 'Orientasi ', 75000, 1, 1, 75000),
(8, 1, '2022-02-23', NULL, '', 'Materi (TAK, Komunikasi Terapeutik, Dokumentasi Keperawatanan) ', 150000, 3, 1, 450000),
(9, 1, '2022-02-23', NULL, '', 'RPS (Resource Person Session)', 150000, 1, 6, 900000),
(10, 1, '2022-02-23', NULL, '', '', 0, 71, 6, 21300000),
(11, 2, '2022-02-23', NULL, 'Administrasi', 'Institusional Fee', 50000, 1, 63, 3150000),
(12, 2, '2022-02-23', NULL, 'Administrasi', 'Management Fee', 75000, 1, 63, 4725000),
(13, 2, '2022-02-23', NULL, 'Barang Habis Pakai', 'Untuk Keselamatan Kerja (Handrub, tisue, sabun)', 20000, 1, 63, 1260000),
(14, 2, '2022-02-23', NULL, 'Overhead Operational', 'Keselamatan Pasien', 150000, 1, 63, 9450000),
(15, 2, '2022-02-23', NULL, 'Overhead Operational', 'Log Book (dibayar 1 kali)', 20000, 1, 63, 1260000),
(16, 2, '2022-02-23', NULL, 'Overhead Operational', 'Name Tag (dibayar 1 kali)', 10000, 1, 63, 630000),
(17, 2, '2022-02-23', NULL, 'Overhead Operational', 'Orientasi ', 75000, 1, 1, 75000),
(18, 2, '2022-02-23', NULL, 'Pembelajaran', 'RPS (Resource Person Session)', 150000, 1, 63, 9450000),
(19, 3, '2022-02-23', NULL, 'Administrasi', 'Institusional Fee', 50000, 1, 33, 1650000),
(20, 3, '2022-02-23', NULL, 'Administrasi', 'Management Fee', 75000, 1, 33, 2475000),
(21, 3, '2022-02-23', NULL, 'Barang Habis Pakai', 'Untuk Keselamatan Kerja (Handrub, tisue, sabun)', 20000, 1, 33, 660000),
(22, 3, '2022-02-23', NULL, 'Overhead Operational', 'Keselamatan Pasien', 150000, 1, 33, 4950000),
(23, 3, '2022-02-23', NULL, 'Overhead Operational', 'Log Book (dibayar 1 kali)', 20000, 1, 33, 660000),
(24, 3, '2022-02-23', NULL, 'Overhead Operational', 'Name Tag (dibayar 1 kali)', 10000, 1, 33, 330000),
(25, 3, '2022-02-23', NULL, 'Overhead Operational', 'Orientasi ', 75000, 1, 1, 75000),
(26, 3, '2022-02-23', NULL, 'Pembelajaran', 'Materi (TAK, Komunikasi Terapeutik, Dokumentasi Keperawatanan) ', 150000, 3, 1, 450000),
(27, 3, '2022-02-23', NULL, 'Pembelajaran', 'RPS (Resource Person Session)', 150000, 1, 33, 4950000),
(28, 3, '2022-02-23', NULL, 'Pembelajaran', '', 0, 1330, 33, 3291750000),
(29, 3, '2022-02-23', NULL, 'Ujian', 'Ujian', 150000, 1, 33, 4950000),
(30, 3, '2022-02-23', NULL, 'Ujian', 'Makan dan Snack Penguji', 20000, 1, 33, 660000),
(31, 3, '2022-02-23', NULL, 'Ujian', 'Bahan Habis Pakai Ujian', 100000, 1, 33, 3300000),
(32, 3, '2022-02-23', NULL, 'Ujian', 'Institusional Fee Ujian', 150000, 1, 33, 4950000),
(33, 3, '2022-02-23', NULL, 'Ujian', 'Management Fee Ujian', 20000, 1, 33, 660000);
...
INSERT INTO `tb_tempat` (`id_tempat`, `nama_tempat`, `kapasitas_tempat`, `id_jurusan_pdd_jenis`, `tarif_tempat`, `id_tarif_satuan`, `tgl_input_tempat`, `ket_tempat`, `status_tempat`) VALUES
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-02-23', '2021-03-29', '2022-02-22', 'Y'),
...
--
ALTER TABLE `tb_tarif_pilih`
  MODIFY `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT untuk tabel `tb_tarif_satuan`
--
ALTER TABLE `tb_tarif_satuan`
  MODIFY `id_tarif_satuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
