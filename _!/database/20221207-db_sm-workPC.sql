...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2022 at 10:01 AM
...
(2, 5, '2022-12-07', '2022-12-07', 'Overhead Operational', 'Voluptates eu ipsam ', 75, 'per-orang', 32, 3, 7200, NULL, NULL, 'Y'),
...
(6, 5, '2022-12-07', '2022-12-07', 'Pembelajaran', 'Dolore vitae asperio', 13, 'per-jam', 35, 50, 22750, NULL, NULL, 'Y'),
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', 1, '08123145645', NULL, '2022-12-07 1:44:16', '2021-03-29', '2022-02-22', NULL, 'Y'),
...
--
ALTER TABLE `tb_tarif_pilih`
  MODIFY `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
