...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2022 at 12:50 AM
...
INSERT INTO `tb_nilai_kep` (`id_nilai_kep`, `id_praktikan`, `ip`, `sptk`, `prepost`, `dokep`, `komter`, `tak`, `penyuluhan`, `presentasi`, `sikap`, `ket_nilai`) VALUES
...
--
ALTER TABLE `tb_tarif_pilih`
  MODIFY `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
