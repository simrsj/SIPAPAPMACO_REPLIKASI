...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2022 at 12:06 AM
...
CREATE TABLE `tb_harga` (
  ...
  `ket_harga` text DEFAULT NULL,
  `jumlah_harga` float NOT NULL,
  `frekuensi_harga` int(11) DEFAULT NULL,
...
(1, 'Institusional Fee', 1, NULL, 50000, NULL, 'SEKALI', 1, 1, 0, 0, 1, 1, NULL),
(2, 'Management Fee', 1, NULL, 75000, NULL, 'SEKALI', 1, 1, 0, 0, 1, 1, NULL),
(3, 'Alat Tulis Kantor', 1, NULL, 5000, NULL, 'SEKALI', 1, 1, 0, 0, 1, 1, NULL),
(4, 'Untuk Keselamatan Kerja (Handrub, tisue, sabun)', 1, NULL, 5000, NULL, 'SEKALI', 1, 1, 0, 0, 2, 1, NULL),
(5, 'Orientasi Keselamatan Pasien', 1, NULL, 10000, NULL, 'SEKALI', 1, 1, 0, 0, 3, 1, NULL),
(6, 'Log Book (dibayar 1 kali)', 1, NULL, 20000, NULL, 'SEKALI', 1, 1, 0, 0, 3, 1, NULL),
(7, 'Name Tag (dibayar 1 kali)', 1, NULL, 5000, NULL, 'SEKALI', 1, 1, 0, 0, 3, 1, NULL),
(8, 'Clinical science session (CSS)', 2, NULL, 37500, NULL, 'SEKALI', 1, 1, 0, 0, 4, 1, NULL),
(9, 'Case report session (CRS)', 2, NULL, 37500, NULL, 'SEKALI', 1, 1, 0, 0, 4, 1, NULL),
(10, 'Case base Discusion (CBD)', 2, NULL, 37500, NULL, 'SEKALI', 1, 1, 0, 0, 4, 1, NULL),
(11, 'Pengayaan - Observasi', 2, NULL, 37500, NULL, 'SEKALI', 1, 1, 0, 0, 4, 1, NULL),
(12, 'RPS (Resource Person Session)', 2, NULL, 37500, NULL, 'SEKALI', 1, 1, 0, 0, 4, 1, NULL),
(13, 'Bed side teaching (BST)- Visite Besar-Role Model - Pembimbingan Kedokteran Umum di IGD', 2, NULL, 37500, NULL, 'SEKALI', 1, 1, 0, 0, 4, 1, NULL),
(14, 'Mini Clinical Examination  Evaluation (Mini CeX)', 2, NULL, 150000, NULL, 'SEKALI', 0, 1, 0, 0, 6, 1, NULL),
(15, 'Ujian', 2, NULL, 150000, NULL, 'SEKALI', 1, 1, 0, 0, 6, 1, NULL),
(16, 'Makan Pembimbing Ujian', 2, NULL, 20000, NULL, 'SEKALI', 1, 1, 0, 0, 6, 1, NULL),
(17, 'Standar Pasien', 2, NULL, 100000, NULL, 'SEKALI', 1, 1, 0, 0, 6, 1, NULL),
(18, 'Institusional Fee', 1, NULL, 50000, NULL, 'SEKALI', 2, 2, 0, 0, 1, 1, NULL),
(19, 'Management Fee', 1, NULL, 75000, NULL, 'SEKALI', 2, 2, 0, 0, 1, 1, NULL),
(20, 'Untuk Keselamatan Kerja (Handrub, tisue, sabun)', 1, NULL, 20000, NULL, 'SEKALI', 2, 2, 0, 0, 2, 1, NULL),
(21, 'Orientasi ', 3, NULL, 75000, NULL, 'SEKALI', 2, 2, 0, 0, 3, 1, NULL),
(22, 'Keselamatan Pasien', 3, NULL, 150000, NULL, 'SEKALI', 2, 2, 0, 0, 3, 1, NULL),
(23, 'Log Book (dibayar 1 kali)', 1, NULL, 20000, NULL, 'SEKALI', 2, 2, 0, 0, 3, 1, NULL),
(24, 'Name Tag (dibayar 1 kali)', 1, NULL, 10000, NULL, 'SEKALI', 2, 2, 0, 0, 3, 1, NULL),
(25, 'RPS (Resource Person Session)', 3, NULL, 150000, NULL, 'SEKALI', 2, 2, 0, 0, 4, 1, NULL),
(26, 'Materi (TAK, Komunikasi Terapeutik, Dokumentasi Keperawatanan) ', 3, '-', 150000, 3, 'SEKALI', 2, 2, 0, 0, 4, 1, '2022-01-26'),
(27, 'Ujian', 4, NULL, 150000, NULL, 'SEKALI', 2, 2, 0, 0, 6, 1, NULL),
(28, 'Makan dan Snack Penguji', 5, NULL, 20000, NULL, 'SEKALI', 2, 2, 0, 0, 6, 1, NULL),
(29, 'Bahan Habis Pakai Ujian', 2, NULL, 100000, NULL, 'SEKALI', 2, 2, 0, 0, 6, 1, NULL),
(30, 'Institusional Fee Ujian', 6, NULL, 150000, NULL, 'SEKALI', 2, 2, 0, 0, 6, 1, NULL),
(31, 'Management Fee Ujian', 6, NULL, 20000, NULL, 'SEKALI', 2, 2, 0, 0, 6, 1, NULL),
(32, 'Institusional Fee', 1, NULL, 20000, NULL, 'SEKALI', 3, 3, 0, 0, 1, 2, NULL),
(33, 'Management Fee', 1, NULL, 20000, NULL, 'SEKALI', 3, 3, 0, 0, 1, 2, NULL),
(34, 'Untuk Keselamatan Kerja (Handrub, tisue, sabun)', 1, NULL, 20000, NULL, 'SEKALI', 3, 3, 0, 0, 2, 1, NULL),
(35, 'Orientasi ', 3, NULL, 75000, NULL, 'SEKALI', 3, 3, 0, 0, 3, 1, NULL),
(36, 'Keselamatan Pasien', 3, NULL, 150000, NULL, 'SEKALI', 3, 3, 0, 0, 3, 1, NULL),
(37, 'Log Book (dibayar 1 kali)', 1, NULL, 20000, NULL, 'SEKALI', 3, 3, 0, 0, 3, 1, NULL),
(38, 'Name Tag (dibayar 1 kali)', 1, NULL, 10000, NULL, 'SEKALI', 3, 3, 0, 0, 3, 1, NULL),
(39, 'RPS (Resource Person Session)', 3, NULL, 150000, NULL, 'SEKALI', 3, 3, 0, 0, 4, 1, NULL),
(40, 'Materi (TAK, Komunikasi Terapeutik, Dokumentasi Keperawatanan) ', 3, NULL, 150000, 3, 'SEKALI', 3, 3, 0, 0, 4, 1, '2022-01-11'),
(41, 'Ujian', 4, NULL, 150000, NULL, 'SEKALI', 3, 3, 0, 0, 6, 1, NULL),
(42, 'Makan dan Snack Penguji', 5, NULL, 20000, NULL, 'SEKALI', 3, 3, 0, 0, 6, 1, NULL),
(43, 'Bahan Habis Pakai Ujian', 2, NULL, 100000, NULL, 'SEKALI', 3, 3, 0, 0, 6, 1, NULL),
(44, 'Institusional Fee Ujian', 6, NULL, 150000, NULL, 'SEKALI', 3, 3, 0, 0, 6, 1, NULL),
(45, 'Management Fee Ujian', 6, NULL, 20000, NULL, 'SEKALI', 3, 3, 0, 0, 6, 1, NULL),
(46, 'Institusional Fee', 1, NULL, 50000, NULL, 'SEKALI', 4, 0, 0, 0, 1, 1, NULL),
(47, 'Management Fee', 1, NULL, 75000, NULL, 'SEKALI', 4, 0, 0, 0, 1, 1, NULL),
(48, 'Untuk Keselamatan Kerja (Handrub, tisue, sabun)', 1, NULL, 20000, NULL, 'SEKALI', 4, 0, 0, 0, 2, 1, NULL),
(49, 'Orientasi ', 3, NULL, 75000, NULL, 'SEKALI', 4, 0, 0, 0, 3, 1, NULL),
(50, 'Keselamatan Pasien', 3, NULL, 150000, NULL, 'SEKALI', 4, 0, 0, 0, 3, 1, NULL),
(51, 'Log Book (dibayar 1 kali)', 1, NULL, 20000, NULL, 'SEKALI', 4, 0, 0, 0, 3, 1, NULL),
(52, 'Name Tag (dibayar 1 kali)', 1, NULL, 10000, NULL, 'SEKALI', 4, 0, 0, 0, 3, 1, NULL),
(53, 'RPS (Resource Person Session)', 3, NULL, 150000, NULL, 'SEKALI', 4, 0, 0, 0, 4, 1, NULL),
(54, 'Materi (TAK, Komunikasi Terapeutik, Dokumentasi Keperawatanan) ', 3, NULL, 150000, 3, 'SEKALI', 4, 0, 0, 0, 4, 1, '2022-01-11'),
(55, 'Ujian', 4, NULL, 150000, NULL, 'SEKALI', 4, 0, 0, 0, 6, 1, NULL),
(56, 'Makan dan Snack Penguji', 5, NULL, 20000, NULL, 'SEKALI', 4, 0, 0, 0, 6, 1, NULL),
(57, 'Bahan Habis Pakai Ujian', 2, NULL, 100000, NULL, 'SEKALI', 4, 0, 0, 0, 6, 1, NULL),
(58, 'Institusional Fee Ujian', 6, NULL, 150000, NULL, 'SEKALI', 4, 0, 0, 0, 6, 1, NULL),
(59, 'Management Fee Ujian', 6, NULL, 20000, NULL, 'SEKALI', 4, 0, 0, 0, 6, 1, NULL),
(60, 'Bed side teaching (BST)', 2, NULL, 50000, NULL, 'MINGGUAN', 0, 0, 6, 0, 4, 2, NULL),
(61, 'Bed side teaching (BST)', 2, NULL, 75000, NULL, 'MINGGUAN', 0, 0, 7, 0, 4, 2, NULL),
(62, 'Bed side teaching (BST)', 2, NULL, 75000, NULL, 'MINGGUAN', 0, 0, 8, 0, 4, 2, NULL),
(63, 'Bed side teaching (BST)', 2, NULL, 75000, NULL, 'MINGGUAN', 0, 0, 10, 0, 4, 2, NULL),
(66, 'Ruang R. Komite Medik', 7, NULL, 750000, NULL, 'HARI-', 1, 1, 0, 0, 7, 2, NULL),
(67, 'Ruang SPI', 7, NULL, 500000, NULL, 'SEKALI', 0, 0, 0, 0, 7, 2, NULL),
(68, 'Ruang Kelas / Ruang Diskusi', 4, NULL, 30000, NULL, 'HARI-', 1, 1, 0, 0, 7, 1, NULL),
(69, 'Aula NAPZA', 7, NULL, 750000, NULL, 'SEKALI', 0, 0, 0, 0, 7, 2, NULL),
(70, 'Aula Utama', 7, NULL, 1000000, NULL, 'SEKALI', 0, 0, 0, 0, 7, 2, NULL),
(71, 'Praktik Kerja Lapangan (PKL)', 8, NULL, 100000, NULL, 'SEKALI', 0, 0, 1, 0, 9, 1, NULL),
(72, 'Praktik Kerja Lapangan (PKL)', 8, NULL, 100000, NULL, 'SEKALI', 0, 0, 2, 0, 9, 1, NULL),
(73, 'Praktik Kerja Lapangan (PKL)', 8, NULL, 100000, NULL, 'SEKALI', 0, 0, 3, 0, 9, 1, NULL),
(74, 'Praktik Kerja Lapangan (PKL)', 8, NULL, 200000, NULL, 'SEKALI', 0, 0, 4, 0, 9, 1, NULL),
(75, 'Praktik Kerja Lapangan (PKL)', 8, NULL, 200000, NULL, 'SEKALI', 0, 0, 5, 0, 9, 1, NULL),
(76, 'Praktik Kerja Lapangan (PKL)', 8, NULL, 200000, NULL, 'SEKALI', 0, 0, 6, 0, 9, 1, NULL),
(77, 'Praktik Kerja Lapangan (PKL)', 8, NULL, 250000, NULL, 'SEKALI', 0, 0, 7, 0, 9, 1, NULL),
(78, 'Praktik Kerja Lapangan (PKL)', 8, NULL, 250000, NULL, 'SEKALI', 0, 0, 8, 0, 9, 1, NULL),
(79, 'Praktik Kerja Lapangan (PKL)', 8, NULL, 350000, NULL, 'SEKALI', 0, 0, 9, 0, 9, 1, NULL),
(80, 'Praktik Kerja Lapangan (PKL)', 8, NULL, 350000, NULL, 'SEKALI', 0, 0, 10, 0, 9, 1, NULL),
(81, 'Praktik Kerja Lapangan (PKL)', 8, NULL, 250000, NULL, 'SEKALI', 0, 0, 11, 0, 9, 1, NULL);
...
INSERT INTO `tb_mess` (`id_mess`, `nama_mess`, `kapasitas_l_mess`, `kapasitas_p_mess`, `kapasitas_t_mess`, `alamat_mess`, `nama_pemilik_mess`, `no_pemilik_mess`, `email_pemilik_mess`, `harga_tanpa_makan_mess`, `harga_dengan_makan_mess`, `ket_mess`, `status_mess`) VALUES
(1, 'Mess RSJ 1 Lama', 0, 0, 20, 'Jl. Kolonel Maturi KM.7, Desa Jambudipa, Kec. Cisarua, Kab. Bandung Barat, 40551', 'RS Jiwa Provinsi Jawa Barat', '081321329101', '', 20000, 100000, 'Makan 3x Sehari', 'Aktif'),
(2, 'Mess RSJ 2 Baru', 0, 0, 92, 'Jl. Kolonel Maturi KM.7, Desa Jambudipa, Kec. Cisarua, Kab. Bandung Barat, 40551', 'RS Jiwa Provinsi Jawa Barat', '081321329101', '', 20000, 100000, '', 'Aktif'),
(3, 'Asrama Rifa Corporate', 0, 0, 100, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Ibu Ai', '081322629909', '', 20000, 80000, 'Dengan Makan 3x Sehari', 'Aktif'),
(4, 'Pondokan H. Ating', 0, 0, 100, 'Kp. Barukai Timur RT. 04 RW. 13 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'H. Ating / Hj. Siti Sutiah', '0', '', 20000, 80000, '', 'Aktif'),
(5, 'Wisma Anugrah Ibu Nanik', 0, 0, 70, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Hj. Nanik Susiani', '081320719652', '', 15000, 70000, '', 'Aktif'),
(6, 'Pondokan dr. Hj. Meutia Laksminingrum', 0, 0, 0, '-', 'dr. Hj. Meutia Laksminingrum', '0', '', 0, 0, '', 'Tidak Aktif'),
(7, 'Galuh Pakuan', 0, 0, 70, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Oyo Suharya', '081320113399', '', 20000, 80000, '', 'Aktif'),
(8, 'Pondokan Tatang', 0, 0, 30, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Tatang', '089531804825', '', 20000, 80000, 'Dengan Makan 3x Sehari', 'Aktif');
...
INSERT INTO `tb_praktik` (`id_praktik`, `id_mou`, `id_institusi`, `id_mentor`, `id_unit`, `nama_praktik`, `tgl_input_praktik`, `tgl_ubah_praktik`, `tgl_mulai_praktik`, `tgl_selesai_praktik`, `jumlah_praktik`, `surat_praktik`, `data_praktik`, `id_jurusan_pdd`, `id_jenjang_pdd`, `id_spesifikasi_pdd`, `id_akreditasi`, `id_user`, `nama_pembimbing_praktik`, `email_pembimbing_praktik`, `telp_pembimbing_praktik`, `status_cek_praktik`, `status_praktik`, `ket_tolak_praktik`) VALUES
(1, 0, 22, NULL, NULL, 'Asperiores pariatur', '2022-01-30', NULL, '2002-03-01', '2323-11-21', 10, NULL, NULL, '3', '4', '15', '2', '1', 'Pariatur Lorem non ', 'boviwevi@mailinator.com', '42', 'DATA PRAKTIK', 'Y', ''),
(2, 0, 85, NULL, NULL, 'Voluptatem magni sae', '2022-01-30', NULL, '2021-06-11', '2323-05-24', 60, NULL, NULL, '4', '6', '0', '3', '1', 'Quia laboris quia om', 'zice@mailinator.com', '10', 'DATA PRAKTIK', 'Y', ''),
(3, 0, 81, NULL, NULL, 'Sunt quam numquam te', '2022-01-30', NULL, '1976-03-26', '2022-01-21', 36, NULL, NULL, '4', '9', '15', '0', '1', 'Rem animi sapiente ', 'jenyxer@mailinator.com', '50', 'DATA PRAKTIK', 'Y', ''),
(4, 0, 49, NULL, NULL, 'Id sunt enim qui nem', '2022-01-30', NULL, '2012-05-21', '2013-10-20', 83, NULL, NULL, '8', '7', '2', '0', '1', 'Nisi blanditiis numq', 'novysupa@mailinator.com', '71', 'DATA PRAKTIK', 'Y', ''),
(5, 0, 75, NULL, NULL, 'Quis adipisci aut as', '2022-01-30', NULL, '1987-09-09', '1989-07-04', 18, NULL, NULL, '7', '7', '15', '0', '1', 'Ea tempora modi omni', 'janebi@mailinator.com', '36', 'DATA PRAKTIK', 'Y', ''),
(6, 0, 46, NULL, NULL, 'Ullam quod cupiditat', '2022-01-30', NULL, '1970-09-01', '2016-07-24', 50, NULL, NULL, '5', '9', '1', '3', '1', 'Impedit vitae magna', 'supulytyh@mailinator.com', '44', 'DATA PRAKTIK', 'Y', ''),
(7, 0, 37, NULL, NULL, 'Id sit a commodo fu', '2022-01-30', NULL, '1994-12-08', '2013-06-11', 79, NULL, NULL, '3', '4', '0', '0', '1', 'Nemo eum tenetur per', 'ropuhixuji@mailinator.com', '54', 'DATA PRAKTIK', 'Y', ''),
(8, 0, 15, NULL, NULL, 'Ullamco aperiam aliq', '2022-01-30', NULL, '1976-11-20', '2019-08-19', 56, NULL, NULL, '7', '5', '2', '3', '1', 'Voluptatibus consequ', 'vigyqohefi@mailinator.com', '44', 'DATA PRAKTIK', 'Y', ''),
(9, 0, 27, NULL, NULL, 'Magna nemo numquam c', '2022-01-30', NULL, '1978-03-13', '2015-12-20', 35, NULL, NULL, '4', '9', '0', '1', '1', 'Numquam est quis in', 'fasumo@mailinator.com', '98', 'DATA PRAKTIK', 'Y', ''),
(10, 0, 40, NULL, NULL, 'Porro aut in unde no', '2022-01-30', NULL, '2017-08-26', '2018-06-07', 39, NULL, NULL, '4', '4', '1', '0', '1', 'Esse odio laboris be', 'gawilysyd@mailinator.com', '24', 'DATA PRAKTIK', 'Y', ''),
(11, 0, 26, NULL, NULL, 'Et et magnam et qui ', '2022-01-30', NULL, '1973-08-11', '2003-08-08', 70, NULL, NULL, '3', '4', '15', '3', '1', 'Qui eum voluptatem ', 'kodyhan@mailinator.com', '100', 'DATA PRAKTIK', 'Y', ''),
(12, 0, 10, NULL, NULL, 'Quae libero eligendi', '2022-01-30', NULL, '1974-11-27', '1988-03-28', 26, NULL, NULL, '6', '9', '15', '2', '1', 'Reprehenderit provi', 'vodidafuz@mailinator.com', '38', 'DATA PRAKTIK', 'Y', ''),
(13, 0, 15, NULL, NULL, 'Consequat Vel numqu', '2022-01-30', NULL, '2010-02-26', '2323-08-03', 84, NULL, NULL, '5', '1', '0', '2', '1', 'Aspernatur nihil cup', 'wolutuz@mailinator.com', '13', 'DATA PRAKTIK', 'Y', ''),
(14, 0, 25, NULL, NULL, 'Sunt dolorum impedit', '2022-01-30', NULL, '1991-05-04', '2009-07-21', 11, NULL, NULL, '1', '4', '0', '1', '1', 'Et laboriosam assum', 'gyla@mailinator.com', '4', 'DATA PRAKTIK', 'Y', ''),
(15, 0, 26, NULL, NULL, 'Consequatur quisquam', '2022-01-30', NULL, '1985-07-09', '1995-07-06', 45, NULL, NULL, '6', '10', '2', '3', '1', 'Beatae impedit dolo', 'xezefyfon@mailinator.com', '13', 'DATA PRAKTIK', 'Y', ''),
(16, 0, 62, NULL, NULL, 'Quo reiciendis bland', '2022-01-30', NULL, '2009-08-11', '2323-03-07', 18, NULL, NULL, '6', '4', '0', '0', '1', 'Impedit ut dolor co', 'wacebunobo@mailinator.com', '79', 'DATA PRAKTIK', 'Y', ''),
(17, 0, 67, NULL, NULL, 'Odit illo officia eu', '2022-01-30', NULL, '1974-02-19', '2011-03-24', 81, NULL, NULL, '1', '10', '0', '0', '1', 'Placeat doloremque ', 'sygusaj@mailinator.com', '80', 'DATA PRAKTIK', 'Y', ''),
(18, 0, 74, NULL, NULL, 'Consequuntur aut odi', '2022-01-30', NULL, '1972-02-21', '1976-03-02', 94, NULL, NULL, '15', '7', '0', '2', '1', 'Et est dolor dolor ', 'bejyji@mailinator.com', '27', 'DATA PRAKTIK', 'Y', ''),
(19, 0, 23, NULL, NULL, 'In voluptate qui dig', '2022-01-30', NULL, '1992-01-26', '2221-02-15', 25, NULL, NULL, '2', '4', '0', '3', '1', 'Eaque veniam eum et', 'dugago@mailinator.com', '90', 'DATA PRAKTIK', 'Y', ''),
(20, 0, 34, NULL, NULL, 'Non doloribus dolor ', '2022-01-30', NULL, '1971-09-07', '1999-01-09', 77, NULL, NULL, '3', '7', '0', '0', '1', 'Optio incididunt en', 'hojabe@mailinator.com', '96', 'DATA PRAKTIK', 'Y', ''),
(21, 0, 85, NULL, NULL, 'Ea sequi vitae ipsum', '2022-01-30', NULL, '2003-05-09', '2004-07-19', 23, NULL, NULL, '2', '4', '15', '3', '1', 'Tenetur consequatur', 'muqago@mailinator.com', '34', 'DATA PRAKTIK', 'Y', ''),
(22, 0, 75, NULL, NULL, 'Reprehenderit et po', '2022-01-30', NULL, '1980-10-22', '2002-07-22', 56, NULL, NULL, '2', '9', '15', '0', '1', 'Dolor cumque nesciun', 'vahubis@mailinator.com', '30', 'DATA PRAKTIK', 'Y', ''),
(23, 0, 72, NULL, NULL, 'Odio sunt qui qui r', '2022-01-30', NULL, '2001-06-18', '2323-03-05', 91, NULL, NULL, '2', '8', '2', '2', '1', 'Aliquam aut animi d', 'koby@mailinator.com', '24', 'DATA PRAKTIK', 'Y', ''),
(24, 0, 66, NULL, NULL, 'Nihil suscipit ea so', '2022-01-30', NULL, '2016-07-14', '2021-08-09', 19, NULL, NULL, '4', '4', '2', '2', '1', 'Maiores accusantium ', 'muxegyvote@mailinator.com', '11', 'DATA PRAKTIK', 'Y', ''),
(25, 0, 13, NULL, NULL, 'Dolorem omnis nobis ', '2022-01-30', NULL, '1973-09-24', '2002-12-08', 91, NULL, NULL, '1', '6', '2', '0', '1', 'Sit molestiae rerum', 'qijelixe@mailinator.com', '16', 'DATA PRAKTIK', 'Y', ''),
(26, 0, 78, NULL, NULL, 'Amet voluptatibus v', '2022-01-30', NULL, '1991-05-22', '1992-04-21', 84, NULL, NULL, '8', '2', '0', '1', '1', 'Et irure et fugiat a', 'takuf@mailinator.com', '3', 'DATA PRAKTIK', 'Y', ''),
(27, 0, 67, NULL, NULL, 'Eu omnis et in omnis', '2022-01-30', NULL, '1986-08-06', '1991-10-18', 62, NULL, NULL, '7', '2', '15', '2', '1', 'Quod magni nostrud e', 'bezucavi@mailinator.com', '52', 'DATA PRAKTIK', 'Y', ''),
(28, 0, 13, NULL, NULL, 'Eaque commodo vitae ', '2022-01-30', NULL, '2008-03-04', '2021-03-25', 38, NULL, NULL, '2', '8', '15', '1', '1', 'Reprehenderit maiore', 'wuvu@mailinator.com', '60', 'DATA PRAKTIK', 'Y', ''),
(29, 0, 26, NULL, NULL, 'Ab dolores et eiusmo', '2022-01-30', NULL, '2008-12-25', '2200-01-01', 77, NULL, NULL, '2', '6', '15', '3', '1', 'Deleniti at voluptat', 'jufut@mailinator.com', '16', 'DATA PRAKTIK', 'Y', ''),
(30, 0, 56, NULL, NULL, 'Ea et rerum vitae ve', '2022-01-30', NULL, '2012-02-01', '2201-11-20', 52, NULL, NULL, '5', '6', '0', '0', '1', 'Quasi qui ea maiores', 'docudimyr@mailinator.com', '7', 'DATA PRAKTIK', 'Y', ''),
(31, 0, 18, NULL, NULL, 'Nisi deleniti amet ', '2022-01-30', NULL, '2001-11-12', '2020-02-07', 54, NULL, NULL, '2', '4', '2', '1', '1', 'Aut aute molestiae n', 'cyryl@mailinator.com', '90', 'DATA PRAKTIK', 'Y', ''),
(32, 0, 83, NULL, NULL, 'Sapiente officia obc', '2022-01-30', NULL, '1998-04-11', '2015-09-07', 41, NULL, NULL, '7', '10', '15', '1', '1', 'Aliquip molestiae ex', 'nenesyv@mailinator.com', '86', 'DATA PRAKTIK', 'Y', ''),
(33, 0, 3, NULL, NULL, 'Laborum illo nemo vo', '2022-01-30', NULL, '2000-08-17', '2323-10-12', 21, NULL, NULL, '7', '7', '15', '2', '1', 'Vel maxime dicta exc', 'mequwotimo@mailinator.com', '14', 'DATA PRAKTIK', 'Y', ''),
(34, 0, 18, NULL, NULL, 'Debitis eum dolores ', '2022-01-30', NULL, '2004-08-27', '2020-01-10', 45, NULL, NULL, '7', '9', '1', '1', '1', 'Expedita minim recus', 'zirogeky@mailinator.com', '38', 'DATA PRAKTIK', 'Y', ''),
(35, 0, 78, NULL, NULL, 'Officiis incididunt ', '2022-01-30', NULL, '2012-07-11', '2222-03-28', 13, NULL, NULL, '6', '4', '2', '3', '1', 'Nisi distinctio Con', 'dyhuwyx@mailinator.com', '57', 'DATA PRAKTIK', 'Y', ''),
(36, 0, 49, NULL, NULL, 'Quasi dolor esse si', '2022-01-30', NULL, '1979-04-17', '1990-12-24', 80, NULL, NULL, '5', '9', '2', '3', '1', 'Optio fuga Non exe', 'citano@mailinator.com', '34', 'DATA PRAKTIK', 'Y', ''),
(37, 0, 76, NULL, NULL, 'Ad voluptas itaque q', '2022-01-30', NULL, '1988-01-26', '2323-07-24', 48, NULL, NULL, '1', '8', '1', '0', '1', 'Delectus et magna u', 'tacakib@mailinator.com', '33', 'DATA PRAKTIK', 'Y', ''),
(38, 0, 13, NULL, NULL, 'Qui excepteur velit ', '2022-01-30', NULL, '2010-12-23', '2017-03-16', 99, NULL, NULL, '3', '2', '15', '3', '1', 'Voluptas voluptates ', 'miqoduvi@mailinator.com', '39', 'DATA PRAKTIK', 'Y', ''),
(39, 0, 45, NULL, NULL, 'Sed eum iste obcaeca', '2022-01-30', NULL, '1982-05-17', '2016-04-13', 33, NULL, NULL, '6', '10', '0', '0', '1', 'Incididunt aut volup', 'liju@mailinator.com', '56', 'DATA PRAKTIK', 'Y', ''),
(40, 0, 68, NULL, NULL, 'Doloribus ea et aute', '2022-01-30', NULL, '1970-12-14', '2014-07-18', 38, NULL, NULL, '1', '6', '0', '2', '1', 'Quidem Nam culpa a ', 'zeperad@mailinator.com', '1', 'DATA PRAKTIK', 'Y', ''),
(41, 0, 4, NULL, NULL, 'Inventore nulla quae', '2022-01-30', NULL, '1995-02-13', '1996-11-07', 93, NULL, NULL, '7', '7', '0', '3', '1', 'Sed sit sit laborio', 'difuhi@mailinator.com', '73', 'DATA PRAKTIK', 'Y', ''),
(42, 0, 82, NULL, NULL, 'Aut ut sit placeat', '2022-01-30', NULL, '2015-09-10', '2323-08-04', 29, NULL, NULL, '4', '6', '15', '0', '1', 'Nisi ad dolore dolor', 'fyvu@mailinator.com', '6', 'DATA PRAKTIK', 'Y', ''),
(43, 0, 69, NULL, NULL, 'Nam asperiores quod ', '2022-01-30', NULL, '2002-02-24', '2010-08-25', 52, NULL, NULL, '4', '10', '2', '0', '1', 'Non voluptates hic i', 'wudidyvyh@mailinator.com', '30', 'DATA PRAKTIK', 'Y', '');
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-01-30', '2021-03-29', '2022-01-17', 'Y'),
...
--
ALTER TABLE `tb_praktik`
  MODIFY `id_praktik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
