...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Feb 2022 pada 11.03
...
INSERT INTO `tb_mess` (`id_mess`, `nama_mess`, `kapasitas_l_mess`, `kapasitas_p_mess`, `kapasitas_t_mess`, `kapasitas_terisi_mess`, `alamat_mess`, `nama_pemilik_mess`, `no_pemilik_mess`, `email_pemilik_mess`, `harga_tanpa_makan_mess`, `harga_dengan_makan_mess`, `kepemilikan_mess`, `ket_mess`, `status_mess`) VALUES
(1, 'Mess RSJ 1 Lama', 0, 0, 20, 0, 'Jl. Kolonel Maturi KM.7, Desa Jambudipa, Kec. Cisarua, Kab. Bandung Barat, 40551', 'RS Jiwa Provinsi Jawa Barat', '081321329101', '', 20000, 100000, 'dalam', 'Makan 3x Sehari', 'Aktif'),
(2, 'Mess RSJ 2 Baru', 0, 0, 92, 0, 'Jl. Kolonel Maturi KM.7, Desa Jambudipa, Kec. Cisarua, Kab. Bandung Barat, 40551', 'RS Jiwa Provinsi Jawa Barat', '081321329101', '', 20000, 100000, 'dalam', '', 'Aktif'),
(3, 'Asrama Rifa Corporate', 0, 0, 100, 0, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Ibu Ai', '081322629909', '', 20000, 80000, 'luar', 'Dengan Makan 3x Sehari', 'Aktif'),
(4, 'Pondokan H. Ating', 0, 0, 100, 0, 'Kp. Barukai Timur RT. 04 RW. 13 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'H. Ating / Hj. Siti Sutiah', '0', '', 20000, 80000, 'luar', '', 'Aktif'),
(5, 'Wisma Anugrah Ibu Nanik', 0, 0, 70, 0, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Hj. Nanik Susiani', '081320719652', '', 15000, 70000, 'luar', '', 'Aktif'),
(6, 'Pondokan dr. Hj. Meutia Laksminingrum', 0, 0, 0, 0, '-', 'dr. Hj. Meutia Laksminingrum', '0', '', 0, 0, 'luar', '', 'Tidak Aktif'),
(7, 'Galuh Pakuan', 0, 0, 70, 0, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Oyo Suharya', '081320113399', '', 20000, 80000, 'luar', '', 'Aktif'),
(8, 'Pondokan Tatang', 0, 0, 30, 0, 'Kp. Panyandaan RT. 01 RW. 14 Desa Jambudipa Kecamatan Cisarua Kab. Bandung Barat', 'Tatang', '089531804825', '', 20000, 80000, 'luar', 'Dengan Makan 3x Sehari', 'Aktif');
...
(2, 0, 45, NULL, NULL, 'Kelompok 1', '2022-02-13', NULL, '2003-01-23', '2004-07-01', 12, './_file/praktik/surat_2_2022-02-13.pdf', './_file/praktik/data_praktikan_2_2022-02-13.xlsx', '2', '8', '0', '2', '1', 'Quis blanditiis poss', 'gadu@mailinator.com', '84', 'TMP', 'D', '', '0');
...
INSERT INTO `tb_tempat_pilih` (`id_tempat_pilih`, `id_tempat`, `id_praktik`, `tgl_input_tempat_pilih`) VALUES
(1, 1, 2, '2022-02-14');
...
--
ALTER TABLE `tb_tempat_pilih`
  MODIFY `id_tempat_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
