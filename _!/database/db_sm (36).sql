...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Feb 2022 pada 07.10
...
(1, 1, 18, '2022-02-15', NULL, 1, 1, 50000),
(2, 1, 19, '2022-02-15', NULL, 1, 1, 75000),
(3, 1, 20, '2022-02-15', NULL, 1, 1, 20000),
(4, 1, 22, '2022-02-15', NULL, 1, 1, 150000),
(5, 1, 23, '2022-02-15', NULL, 1, 1, 20000),
(6, 1, 24, '2022-02-15', NULL, 1, 1, 10000),
(7, 1, 21, '2022-02-15', NULL, 1, 1, 75000),
(8, 1, 26, '2022-02-15', NULL, 3, 1, 450000),
(9, 1, 25, '2022-02-15', NULL, 1, 1, 150000),
(10, 1, 62, '2022-02-15', NULL, 890, 1, 66750000),
(11, 1, 27, '2022-02-15', NULL, 1, 1, 150000),
(12, 1, 28, '2022-02-15', NULL, 1, 1, 20000),
(13, 1, 29, '2022-02-15', NULL, 1, 1, 100000),
(14, 1, 30, '2022-02-15', NULL, 1, 1, 150000),
(15, 1, 31, '2022-02-15', NULL, 1, 1, 20000);
...
(1, 1, 3, '2022-02-15', 'y', 6233, 498640000);
...
(1, 0, 30, NULL, NULL, 'Kelompok 1', '2022-02-15', NULL, '2003-10-23', '2020-11-14', 1, './_file/praktik/surat_1_2022-02-15.pdf', './_file/praktik/data_praktikan_1_2022-02-15.xlsx', '2', '8', '2', '2', '1', 'Eligendi eaque quia ', 'nofiruc@mailinator.com', '3', 'SLS', 'Y', '', '');
...
CREATE TABLE `tb_tempat_pilih` (
  ...
  `total_harga_tempat_pilih` int(11) NOT NULL,
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-02-15', '2021-03-29', '2022-01-17', 'Y'),
