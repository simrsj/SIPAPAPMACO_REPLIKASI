...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2022 at 10:08 AM
...
(2, 0, 73, NULL, NULL, 'Aliqua Nulla est qu', '2022-02-27', NULL, '1978-05-14', '2001-11-13', 96, 'Corporis voluptatem', './_file/praktik/surat_2_2022-02-27.pdf', './_file/praktik/data_praktikan_2_2022-02-27.xlsx', 1, '1', '8', '0', '1', '1', 'Eius et omnis commod', 'gice@mailinator.com', '82', 'TMP_KED', 'D', '', '', '', 't', 't');
...
(1, 0, 0, 'admin', 'e1d5be1c7f2f456670de3d53c7b54f4a', 'ADMIN DIKLAT RS JIWA', 'admin@admin', '1', '08123145645', NULL, '2022-02-26', '2021-03-29', '2022-02-22', 'Y'),
...
--
ALTER TABLE `tb_tarif_pilih`
  MODIFY `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
