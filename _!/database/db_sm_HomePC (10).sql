...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2022 at 02:31 PM
...
(1, NULL, 1, 'B1220223', 'Fajar Rachmat Hermansyah', '019273901273', 'Bank BJB', '2022-02-20', '2022-02-24', './_file/bayar/bayar_1_1_2022-02-24.pdf'),
(2, NULL, 1, 'B1220223', 'Fajar', 'Rachmat', ' qsdf', '2022-02-26', '2022-02-24', './_file/bayar/bayar_2_1_2022-02-24.pdf');
...
INSERT INTO `tb_praktik` (`id_praktik`, `id_mou`, `id_institusi`, `id_mentor`, `id_unit`, `nama_praktik`, `tgl_input_praktik`, `tgl_ubah_praktik`, `tgl_mulai_praktik`, `tgl_selesai_praktik`, `jumlah_praktik`, `surat_praktik`, `data_praktik`, `id_jurusan_pdd_jenis`, `id_jurusan_pdd`, `id_jenjang_pdd`, `id_spesifikasi_pdd`, `id_akreditasi`, `id_user`, `nama_koordinator_praktik`, `email_koordinator_praktik`, `telp_koordinator_praktik`, `status_cek_praktik`, `status_praktik`, `kurang_tf_praktik`, `ket_tolakPraktikTarif_praktik`) VALUES
(1, 0, 85, NULL, NULL, 'Velit porro suscipit', '2022-02-23', NULL, '2014-12-08', '2323-04-08', 46, './_file/praktik/surat_1_2022-02-23.pdf', './_file/praktik/data_praktikan_1_2022-02-23.xlsx', 2, '2', '8', '15', '2', '1', 'Ipsam ipsa sit sed', 'kenypeb@mailinator.com', '95', 'SLS', 'Y', '909090', ''),
(2, 0, 38, NULL, NULL, 'Unde irure qui et mo', '2022-02-24', NULL, '1996-11-03', '1996-12-27', 90, './_file/praktik/surat_2_2022-02-24.pdf', './_file/praktik/data_praktikan_2_2022-02-24.xlsx', 1, '1', '1', '15', '1', '1', 'Illo voluptatum ut u', 'gety@mailinator.com', '92', 'VPT_Y', 'D', '', 'asdasd');
...
(36, 2, '2022-02-24', NULL, 'Administrasi', 'Alat Tulis Kantor', 5000, 'persiswa/periode', 1, 90, 450000),
(37, 2, '2022-02-24', NULL, 'Administrasi', 'Institusional Fee', 50000, 'persiswa/periode', 1, 90, 4500000),
(38, 2, '2022-02-24', NULL, 'Administrasi', 'Management Fee', 75000, 'persiswa/periode', 1, 90, 6750000),
(39, 2, '2022-02-24', NULL, 'Barang Habis Pakai', 'Untuk Keselamatan Kerja (Handrub, tisue, sabun)', 5000, 'persiswa/periode', 1, 90, 450000),
(40, 2, '2022-02-24', NULL, 'Overhead Operational', 'Log Book (dibayar 1 kali)', 20000, 'persiswa/periode', 1, 90, 1800000),
(41, 2, '2022-02-24', NULL, 'Overhead Operational', 'Name Tag (dibayar 1 kali)', 5000, 'persiswa/periode', 1, 90, 450000),
(42, 2, '2022-02-24', NULL, 'Overhead Operational', 'Orientasi Keselamatan Pasien', 10000, 'persiswa/periode', 1, 90, 900000),
(43, 2, '2022-02-24', NULL, 'Pembelajaran', 'Bed side teaching (BST)- Visite Besar-Role Model - Pembimbingan Kedokteran Umum di IGD', 37500, 'persiswa/kali', 1, 90, 3375000),
(44, 2, '2022-02-24', NULL, 'Pembelajaran', 'Case base Discusion (CBD)', 37500, 'persiswa/kali', 1, 90, 3375000),
(45, 2, '2022-02-24', NULL, 'Pembelajaran', 'Case report session (CRS)', 37500, 'persiswa/kali', 1, 90, 3375000),
(46, 2, '2022-02-24', NULL, 'Pembelajaran', 'Clinical science session (CSS)', 37500, 'persiswa/kali', 1, 90, 3375000),
(47, 2, '2022-02-24', NULL, 'Pembelajaran', 'Pengayaan - Observasi', 37500, 'persiswa/kali', 1, 90, 3375000),
(48, 2, '2022-02-24', NULL, 'Pembelajaran', 'RPS (Resource Person Session)', 37500, 'persiswa/kali', 1, 90, 3375000),
(49, 2, '2022-02-24', NULL, 'Ujian', 'Mini Clinical Examination  Evaluation (Mini CeX)', 150000, 'persiswa/kali', 1, 90, 13500000),
(50, 2, '2022-02-24', NULL, 'Ujian', 'Ujian', 150000, 'persiswa/kali', 1, 90, 13500000),
(51, 2, '2022-02-24', NULL, 'Ujian', 'Makan Pembimbing Ujian', 20000, 'persiswa/kali', 1, 90, 1800000),
(52, 2, '2022-02-24', NULL, 'Ujian', 'Standar Pasien', 100000, 'persiswa/kali', 1, 90, 9000000);
...
--
ALTER TABLE `tb_tarif_pilih`
  MODIFY `id_tarif_pilih` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
